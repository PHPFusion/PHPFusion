...
if (isset($_GET['cat_id']) && isnum($_GET['cat_id'])) {
    ...
    if (dbrows($result)) {
        ...
        while ($data = dbarray($result)) {
            ...
            if ($rows) {
                ...
                if ($rows > 10) {
                    echo "<div style='text-align:right'>".THEME_BULLET." <a href='".BASEDIR."blog_cats.php?cat_id=".$data['blog_cat_id']."'>".$locale['blog_405']."</a></div>\n";
                }
            } else {
    ...
    if (dbrows($result)) {
        ...
        $res = 1;
        if ($nrows > 10) {
            echo "<div style='text-align:right'>".THEME_BULLET." <a href='".BASEDIR."blog_cats.php?cat_id=0'>".$locale['blog_405']."</a></div>\n";
        }
        echo "</td>\n</tr>\n";
    }
    if ($res == 1) {

<?php
    ...
    if (sizeof($enabled_languages) > 1) {
        if (file_exists(INFUSIONS."language_panel/locale/".LANGUAGE.".php")) {
            include INFUSIONS."language_panel/locale/".LANGUAGE.".php";
        } else {
            include INFUSIONS."language_panel/locale/English.php";
        }

...
class ArticlesAdminView extends ArticlesAdminModel {
    ...
    public function display_admin() {
		...
		\PHPFusion\BreadCrumbs::getInstance()->addBreadCrumb(array("link" => INFUSIONS."articles/articles_admin.php".fusion_get_aidlink(), "title" => $this->locale['article_0000']));
		
		$articleTitle = $this->locale['article_0001'];
		$articleCatTitle = $this->locale['article_0004'];
		
		if ($_GET['section'] == "article") {
			\PHPFusion\BreadCrumbs::getInstance()->addBreadCrumb(array("link" => INFUSIONS."articles/articles_admin.php".fusion_get_aidlink()."&amp;section=article", "title" => $this->locale['article_0001']));
			if (isset($_GET['ref']) && $_GET['ref'] == "article_form") {
				if (!isset($_GET['article_id'])) {
					\PHPFusion\BreadCrumbs::getInstance()->addBreadCrumb(array("link" => INFUSIONS."articles/articles_admin.php".fusion_get_aidlink()."&amp;section=article&amp;ref=article_form", "title" => $this->locale['article_0002']));
					$articleTitle = $this->locale['article_0002'];
				} else {
					\PHPFusion\BreadCrumbs::getInstance()->addBreadCrumb(array("link" => INFUSIONS."articles/articles_admin.php".fusion_get_aidlink()."&amp;section=article&amp;ref=article_form", "title" => $this->locale['article_0003']));
		...
		if ($_GET['section'] == "article_category") {
			\PHPFusion\BreadCrumbs::getInstance()->addBreadCrumb(array("link" => INFUSIONS."articles/articles_admin.php".fusion_get_aidlink()."&amp;section=article_category", "title" => $this->locale['article_0004']));
			if (isset($_GET['ref']) && $_GET['ref'] == "article_cat_form") {
				if (!isset($_GET['cat_id'])) {
					\PHPFusion\BreadCrumbs::getInstance()->addBreadCrumb(array("link" => INFUSIONS."articles/articles_admin.php".fusion_get_aidlink()."&amp;section=article_category&amp;ref=article_cat_form", "title" => $this->locale['article_0005']));
					$articleCatTitle = $this->locale['article_0005'];
				} else {
					\PHPFusion\BreadCrumbs::getInstance()->addBreadCrumb(array("link" => INFUSIONS."articles/articles_admin.php".fusion_get_aidlink()."&amp;section=article_category&amp;ref=article_cat_form", "title" => $this->locale['article_0006']));
		...
		if ($_GET['section'] == "submissions") {
			\PHPFusion\BreadCrumbs::getInstance()->addBreadCrumb(array("link" => INFUSIONS."articles/articles_admin.php".fusion_get_aidlink()."&amp;section=submissions", "title" => $this->locale['article_0007']));
		}
		
		if ($_GET['section'] == "settings") {
			\PHPFusion\BreadCrumbs::getInstance()->addBreadCrumb(array("link" => INFUSIONS."articles/articles_admin.php".fusion_get_aidlink()."&amp;section=settings", "title" => $this->locale['article_0008']));
		}

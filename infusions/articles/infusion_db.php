...
if ((!empty($inf_settings['article_allow_submission']) && $inf_settings['article_allow_submission']) && (!empty($inf_settings['article_submission_visibility']) && checkgroup($inf_settings['article_submission_visibility']))) {

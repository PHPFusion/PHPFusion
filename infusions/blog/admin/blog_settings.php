...
if (isset($_POST['savesettings'])) {
	$error = 0;
	$inputArray = array("blog_allow_submission" => form_sanitizer($_POST['blog_allow_submission'], 0, "blog_allow_submission"),
	...
	if (defender::safe()) {
		foreach ($inputArray as $settings_name => $settings_value) {
			$inputSettings = array("settings_name" => $settings_name,
...
openside('');
echo form_text("blog_pagination", $locale['669b'], $blog_settings['blog_pagination'], array("inline" => TRUE,
	"max_length" => 4,
	"width" => "150px",
	"type" => "number"));
echo "
<div class='row'>
	...
	".form_text('blog_thumb_w', '', $blog_settings['blog_thumb_w'], array('class' => 'pull-left',
		'max_length' => 4,
		'number' => 1,
		'width' => '150px'))."
	<i class='entypo icancel pull-left m-r-10 m-l-0 m-t-10'></i>
	".form_text('blog_thumb_h', '', $blog_settings['blog_thumb_h'], array('class' => 'pull-left',
		'max_length' => 4,
		'number' => 1,
		'width' => '150px'))."
...
<div class='row'>
	...
	<div class='col-xs-12 col-sm-9'>
	".form_text('blog_photo_w', '', $blog_settings['blog_photo_w'], array('class' => 'pull-left',
		'max_length' => 4,
		'number' => 1,
		'width' => '150px'))."
	<i class='entypo icancel pull-left m-r-10 m-l-0 m-t-10'></i>
	".form_text('blog_photo_h', '', $blog_settings['blog_photo_h'], array('class' => 'pull-left',
		'max_length' => 4,
		'number' => 1,
		'width' => '150px'))."
	<small class='m-l-10 mid-opacity text-uppercase pull-left m-t-10'>( ".$locale['604']." )</small>
...
<div class='row'>
	...
	<div class='col-xs-12 col-sm-9'>
	".form_text('blog_photo_max_w', '', $blog_settings['blog_photo_max_w'], array('class' => 'pull-left',
		'max_length' => 4,
		'number' => 1,
		'width' => '150px'))."
	<i class='entypo icancel pull-left m-r-10 m-l-0 m-t-10'></i>
	".form_text('blog_photo_max_h', '', $blog_settings['blog_photo_max_h'], array('class' => 'pull-left',
		'max_length' => 4,
		'number' => 1,
		'width' => '150px'))."
	<small class='m-l-10 mid-opacity text-uppercase pull-left m-t-10'>( ".$locale['604']." )</small>
...
closeside();
openside("");
echo form_select("blog_allow_submission", $locale['blog_0600'], $blog_settings['blog_allow_submission'], array("inline" => TRUE,
	"options" => array($locale['disable'], $locale['enable'])));
echo form_select("blog_allow_submission_files", $locale['blog_0601'], $blog_settings['blog_allow_submission_files'], array("inline" => TRUE,
	"options" => array($locale['disable'], $locale['enable'])));

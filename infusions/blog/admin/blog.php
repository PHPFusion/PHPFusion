...
if (isset($_POST['save'])) {
	$data = array('blog_id' => form_sanitizer($_POST['blog_id'], 0, 'blog_id'),
...
if (isset($_POST['preview'])) {
	...
	$data = array("blog_subject" => form_sanitizer($_POST['blog_subject'], '', 'blog_subject'),
...
echo form_text('blog_subject', $locale['blog_0422'], $data['blog_subject'], array('required' => TRUE,
	'max_length' => 200,
	'error_text' => $locale['blog_0450']));
// move keywords here because it's required
echo form_select('blog_keywords', $locale['blog_0443'], $data['blog_keywords'], array("max_length" => 320,
...
openside('');
echo form_select_tree("blog_cat", $locale['blog_0423'], $data['blog_cat'], array("width" => "100%",
									"inline" => TRUE,
...
echo form_button('save', $locale['blog_0437'], $locale['blog_0437'], array('class' => 'btn-success',

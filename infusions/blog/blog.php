...
if (isset($_GET['readmore']) && isnum($_GET['readmore'])) {
    ...
    if (!empty($info['blog_rows'])) {
        ...
        while ($data = dbarray($result)) {
            ...
            $blog_image = "<a href='".INFUSIONS."blog/blog.php?readmore=".$data['blog_id']."'>".thumbnail(INFUSIONS."blog/images/blog_default.jpg",
                                                                                                          '150px')."</a>";
            $hiRes_image_path = "";
            $lowRes_image_path = "";
            ...
            $cdata = array(
                ...
                'blog_extended' => preg_replace("/<!?--\s*pagebreak\s*-->/i", "",
                    ($data['blog_breaks'] == "y" ? nl2br($blog_extended) : $blog_extended)),

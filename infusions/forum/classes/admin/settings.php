...
class ForumAdminSettings extends ForumAdminInterface {
    ...
    public function viewSettingsAdmin() {
        ...
        if (isset($_POST['savesettings'])) {
            ...
            $attachtypes = form_sanitizer($_POST['forum_attachtypes'], '.pdf,.gif,.jpg,.png,.zip,.rar,.tar,.bz2,.7z',
                                          'forum_attachtypes');
            ...
            $popular_threads_timeframe = form_sanitizer($_POST['popular_threads_timeframe'], '604800',
            ...
            $forum_editpost_to_lastpost = form_sanitizer($_POST['forum_editpost_to_lastpost'], '0',
                                                         'forum_editpost_to_lastpost');

...
if (iMEMBER) {
    ...
    if (!preg_match('/login.php/i', FUSION_SELF)) {
        ...
        $info = [
            ...
            'login_name_input'     => form_text('user_name', $locale['global_101'], '', [
                'placeholder' => $placeholder,
                'required'    => 1
            ]),
            'login_pass_input'     => form_text('user_pass', $locale['global_102'], '', [
                'placeholder' => $locale['global_102'],
                'type'        => 'password',
                'required'    => 1
            ]),
            'login_remember_input' => form_checkbox('remember_me', $locale['global_103'], '', ['value' => 'y']),
            'login_submit'         => form_button('login', $locale['global_104'], '', ['class' => 'm-t-20 m-b-20 btn-block btn-primary']),
            'registration_link'    => (fusion_get_settings('enable_registration') ? strtr($locale['global_105'], ['[LINK]' => "<a href='".BASEDIR."register.php'>", '[/LINK]' => "</a>\n"]) : ''),
            'lostpassword_link'    => strtr($locale['global_106'], ['[LINK]' => "<a href='".BASEDIR."lostpassword.php'>", '[/LINK]' => "</a>"])
        ];

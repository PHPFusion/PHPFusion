...
if (iMEMBER) {
	...
	if (!preg_match('/login.php/i', FUSION_SELF)) {
		...
		echo form_text($locale['global_101'], 'user_name', 'user_name', '', array('placeholder' => $locale['global_101'],
																				  'required' => 1));
		echo form_text($locale['global_102'], 'user_pass', 'user_pass', '', array('placeholder' => $locale['global_102'],

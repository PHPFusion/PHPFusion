...
if ((!empty($inf_settings['faq_allow_submission']) && $inf_settings['faq_allow_submission']) && (!empty($inf_settings['faq_submission_access']) && checkgroup($inf_settings['faq_submission_access']))) {

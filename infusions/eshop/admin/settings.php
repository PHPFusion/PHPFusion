...
echo "<div class='well'>".$locale['ESHP205']."</div>";
$data = array(
	'eshop_ipn'=>1,
	'esho_cats'=>1,
	'eshop_cat_disp'=>1,
...
if (isset($_POST['update_settings'])) {
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_ipn'])."' WHERE settings_name='eshop_ipn'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_cats'])."' WHERE settings_name='eshop_cats'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_cat_disp'])."' WHERE settings_name='eshop_cat_disp'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_nopp'])."' WHERE settings_name='eshop_nopp'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_noppf'])."' WHERE settings_name='eshop_noppf'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_shopmode'])."' WHERE settings_name='eshop_shopmode'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_returnpage'])."' WHERE settings_name='eshop_returnpage'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_target'])."' WHERE settings_name='eshop_target'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_folderlink'])."' WHERE settings_name='eshop_folderlink'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_selection'])."' WHERE settings_name='eshop_selection'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_cookies'])."' WHERE settings_name='eshop_cookies'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_bclines'])."' WHERE settings_name='eshop_bclines'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_icons'])."' WHERE settings_name='eshop_icons'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_statustext'])."' WHERE settings_name='eshop_statustext'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_closesamelevel'])."' WHERE settings_name='eshop_closesamelevel'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_inorder'])."' WHERE settings_name='eshop_inorder'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_ratios'])."' WHERE settings_name='eshop_ratios'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_idisp_h'])."' WHERE settings_name='eshop_idisp_h'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_idisp_w'])."' WHERE settings_name='eshop_idisp_w'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_idisp_h2'])."' WHERE settings_name='eshop_idisp_h2'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_idisp_w2'])."' WHERE settings_name='eshop_idisp_w2'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_ipr'])."' WHERE settings_name='eshop_ipr'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_ppmail'])."' WHERE settings_name='eshop_ppmail'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_catimg_w'])."' WHERE settings_name='eshop_catimg_w'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_catimg_h'])."' WHERE settings_name='eshop_catimg_h'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_image_w'])."' WHERE settings_name='eshop_image_w'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_image_h'])."' WHERE settings_name='eshop_image_h'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_image_b'])."' WHERE settings_name='eshop_image_b'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_image_tw'])."' WHERE settings_name='eshop_image_tw'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_image_th'])."' WHERE settings_name='eshop_image_th'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_image_t2w'])."' WHERE settings_name='eshop_image_t2w'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_image_t2h'])."' WHERE settings_name='eshop_image_t2h'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_buynow_color'])."' WHERE settings_name='eshop_buynow_color'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_checkout_color'])."' WHERE settings_name='eshop_checkout_color'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_cart_color'])."' WHERE settings_name='eshop_cart_color'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_addtocart_color'])."' WHERE settings_name='eshop_addtocart_color'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_info_color'])."' WHERE settings_name='eshop_info_color'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_return_color'])."' WHERE settings_name='eshop_return_color'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_pretext'])."' WHERE settings_name='eshop_pretext'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_pretext_w'])."' WHERE settings_name='eshop_pretext_w'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_listprice'])."' WHERE settings_name='eshop_listprice'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_currency'])."' WHERE settings_name='eshop_currency'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_shareing'])."' WHERE settings_name='eshop_shareing'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_weightscale'])."' WHERE settings_name='eshop_weightscale'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_vat'])."' WHERE settings_name='eshop_vat'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_vat_default'])."' WHERE settings_name='eshop_vat_default'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_itembox_w'])."' WHERE settings_name='eshop_itembox_w'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_itembox_h'])."' WHERE settings_name='eshop_itembox_h'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_cipr'])."' WHERE settings_name='eshop_cipr'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_newtime'])."' WHERE settings_name='eshop_newtime'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_coupons'])."' WHERE settings_name='eshop_coupons'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".stripinput($_POST['eshop_freeshipsum'])."' WHERE settings_name='eshop_freeshipsum'");
	$result = dbquery("UPDATE ".DB_SETTINGS_INF." SET settings_value='".addslash(preg_replace("(^<p>\s</p>$)", "", $_POST['eshop_terms']))."' WHERE settings_name='eshop_terms'");
	addNotice('success', $locale['ESHP500']);
	redirect(FUSION_SELF.$aidlink."&amp;a_page=settings");
}
$settings2 = array();
$result = dbquery("SELECT * FROM ".DB_SETTINGS_INF." WHERE settings_inf = 'eshop'");
...
if (dbrows($result) != 0) {
	...
	closeside();
	openside('');
	echo form_textarea('eshop_terms', $locale['ESHP831'] , $settings2['eshop_terms'], array(
				'width' => '100%',
				'height' => '260px',
				'form_name'=>'optionsform',
				'html'=>1,
		));
	closeside();
	echo "</div>\n";

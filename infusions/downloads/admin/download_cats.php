...
if ((isset($_GET['action']) && $_GET['action'] == "delete") && (isset($_GET['cat_id']) && isnum($_GET['cat_id']))) {
	...
	$tab_title['id'][] = "dcats";
	$tab_title['icon'][] = "";
	$tab_title['title'][] = $locale['download_0021'];
	$tab_title['id'][] = "dadd";
	$tab_title['icon'][] = "";
	...
	openside('');
	echo form_text('cat_name', $locale['download_0300'], $cat_name, array(
		'required' => 1,
		'error_text' => $locale['download_0351']
	));
	echo form_textarea('cat_description', $locale['download_0301'], $cat_description, array(
		'resize' => 0,
		'autosize' => 1
	));
	echo "<div class='clearfix'>\n";
	echo form_select('cat_sort_by', $locale['download_0302'], $cat_sort_by, array(
		'options' => $array,
	...
	openside('');
	echo form_select_tree("cat_parent", $locale['download_0308'], $cat_parent, array(

...
openside('');
echo form_text("news_pagination", $locale['669c'], $news_settings['news_pagination'], array("inline"=>true, "max_length"=>4, "width"=>"150px", "type"=>"number"));
echo "
<div class='row'>
	...
	".form_text('news_thumb_w', '', $news_settings['news_thumb_w'], array('class' => 'pull-left', 'max_length' => 4, 'number'=>1, 'width'=>'150px'))."
	<i class='entypo icancel pull-left m-r-10 m-l-0 m-t-10'></i>
	".form_text('news_thumb_h', '', $news_settings['news_thumb_h'], array('class' => 'pull-left', 'max_length' => 4, 'number' => 1, 'width'=>'150px'))."
...
<div class='row'>
	...
	<div class='col-xs-12 col-sm-9'>
	".form_text('news_photo_w', '', $news_settings['news_photo_w'], array('class' => 'pull-left', 'max_length' => 4, 'number'=>1, 'width'=>'150px'))."
	<i class='entypo icancel pull-left m-r-10 m-l-0 m-t-10'></i>
	".form_text('news_photo_h', '', $news_settings['news_photo_h'], array('class' => 'pull-left', 'max_length' => 4, 'number' => 1, 'width'=>'150px'))."
	<small class='m-l-10 mid-opacity text-uppercase pull-left m-t-10'>( ".$locale['604']." )</small>
	</div>
</div>";
echo "
<div class='row'>
	...
	<div class='col-xs-12 col-sm-9'>
	".form_text('news_photo_max_w', '', $news_settings['news_photo_max_w'], array('class' => 'pull-left', 'max_length' => 4, 'number'=>1, 'width'=>'150px'))."
	<i class='entypo icancel pull-left m-r-10 m-l-0 m-t-10'></i>
	".form_text('news_photo_max_h', '', $news_settings['news_photo_max_h'], array('class' => 'pull-left', 'max_length' => 4, 'number' => 1, 'width'=>'150px'))."
	<small class='m-l-10 mid-opacity text-uppercase pull-left m-t-10'>( ".$locale['604']." )</small>
	</div>
</div>";
echo "
...
echo form_select('news_image_frontpage', $locale['957'], $news_settings['news_image_frontpage'], array("options" => $cat_opts));
echo form_select('news_image_readmore', $locale['958'], $news_settings['news_image_readmore'], array("options" => $cat_opts));
echo form_select('news_thumb_ratio', $locale['954'], $news_settings['news_thumb_ratio'], array("options" => $thumb_opts));
closeside();
echo "</div></div>\n";

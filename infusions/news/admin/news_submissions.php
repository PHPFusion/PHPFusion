	...
	if (isset($_POST['publish']) && (isset($_GET['submit_id']) && isnum($_GET['submit_id']))) {
		...
		if (dbrows($result) > 0) {
			...
			$callback_data = array(
				...
				"news_image" => $submit_criteria['news_image'], "news_image_t1" => $submit_criteria['news_image_t1'],
				"news_image_t2" => $submit_criteria['news_image_t2'], "news_ialign" => $submit_criteria['news_ialign'],

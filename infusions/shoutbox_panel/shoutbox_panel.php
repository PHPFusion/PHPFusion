<?php
    ...
    if (iMEMBER || $shout_settings['guest_shouts'] == "1") {
        ...
        echo form_textarea('', 'shout_message', 'shout_message', $shout_message);
        if (iGUEST) {
        ...
        echo form_button($locale['SB_shout'], 'post_shout', 'post_shout', $locale['SB_shout'], array('class' => 'btn-block btn-primary button', 'icon' => "entypo icomment"));
        echo closeform();
    } else {

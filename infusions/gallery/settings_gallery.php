...
<div class='row'>
	...
	".form_text('thumb_w', '', $settings2['thumb_w'], array('class' => 'pull-left m-r-10',
		'max_length' => 4,
		'number' => 1,
		'width' => '150px'))."
	<i class='entypo icancel pull-left m-r-10 m-l-0 m-t-10'></i>
	".form_text('thumb_h', '', $settings2['thumb_h'], array('class' => 'pull-left',
		'max_length' => 4,
		'number' => 1,
		'width' => '150px'))."
...
<div class='row'>
	...
	<div class='col-xs-12 col-sm-9'>
	".form_text('photo_w', '', $settings2['photo_w'], array('class' => 'pull-left m-r-10',
		'max_length' => 4,
		'number' => 1,
		'width' => '150px'))."
	<i class='entypo icancel pull-left m-r-10 m-l-0 m-t-10'></i>
	".form_text('photo_h', '', $settings2['photo_h'], array('class' => 'pull-left',
		'max_length' => 4,
		'number' => 1,
		'width' => '150px'))."
	<small class='m-l-10 mid-opacity text-uppercase pull-left m-t-10'>( ".$locale['604']." )</small>
...
<div class='row'>
	...
	<div class='col-xs-12 col-sm-9'>
	".form_text('photo_max_w', '', $settings2['photo_max_w'], array('class' => 'pull-left m-r-10',
		'max_length' => 4,
		'number' => 1,
		'width' => '150px'))."
	<i class='entypo icancel pull-left m-r-10 m-l-0 m-t-10'></i>
	".form_text('photo_max_h', '', $settings2['photo_max_h'], array('class' => 'pull-left',
		'max_length' => 4,
		'number' => 1,
		'width' => '150px'))."
	<small class='m-l-10 mid-opacity text-uppercase pull-left m-t-10'>( ".$locale['604']." )</small>
...
echo form_text('admin_thumbs_per_row', $locale['609b'], $settings2['admin_thumbs_per_row'], array('max_length' => 2,
	'inline' => 1,
	'width' => '100px'));
echo form_text('thumbs_per_row', $locale['609'], $settings2['thumbs_per_row'], array('max_length' => 2,
	'inline' => 1,
	'width' => '100px'));
echo form_text('thumbs_per_page', $locale['610'], $settings2['thumbs_per_page'], array('max_length' => 2,
	'inline' => 1,
	'width' => '100px'));
closeside();
openside('');
echo form_colorpicker('photo_watermark_text_color1', $locale['614'], $settings2['photo_watermark_text_color1'], array('inline' => 1,
	'deactivate' => !$settings2['photo_watermark'] ? 1 : 0));
echo form_colorpicker('photo_watermark_text_color2', $locale['615'], $settings2['photo_watermark_text_color2'], array('inline' => 1,
	'deactivate' => !$settings2['photo_watermark'] ? 1 : 0));
echo form_colorpicker('photo_watermark_text_color3', $locale['616'], $settings2['photo_watermark_text_color3'], array('inline' => 1,
	'deactivate' => !$settings2['photo_watermark'] ? 1 : 0));
closeside();
echo "</div><div class='col-xs-12 col-sm-3'>\n";
echo form_button('savesettings', $locale['750'], $locale['750'], array('class' => 'btn-success m-b-10'));
openside('');
echo form_select('photo_watermark', $locale['611'], $settings2['photo_watermark'], array('options' => $choice_opts,
	'width' => '100%'));
echo form_select('photo_watermark_save', $locale['617'], $settings2['photo_watermark_save'], array('options' => $choice_opts,
	'width' => '100%'));
echo form_button('delete_watermarks', $locale['619'], $locale['619'], array('deactivate' => !$settings2['photo_watermark'] ? 1 : 0,
...
echo form_select('photo_watermark_text', $locale['613'], $settings2['photo_watermark_text'], array('options' => $choice_opts,
	'deactivate' => !$settings2['photo_watermark'] ? 1 : 0,
	'width' => '100%'));
closeside();
echo "</div></div>

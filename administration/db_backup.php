...
if (isset($_POST['btn_do_restore'])) {
	...
	echo form_text($locale['415'], 'restore_tblpre', 'restore_tblpre', $info_tblpref, array('required' => 1,
																							'error_text' => ''));
	echo "</td>\n</tr>\n<tr>\n";
	...
	echo "</tr>\n<tr>\n";
	echo "<td colspan='2' class='tbl'>\n";
	echo form_text($locale['460'], 'user_admin_password', 'user_admin_password', '', array('required' => 1,
	...
	echo "<td class='tbl'>\n";
	echo form_text('', 'backup_filename', 'backup_filename', "backup_".stripsiteinput($settings['sitename'])."_".date('Y-m-d-Hi')."", array('required' => 1,
	...
	echo "<td class='tbl'>\n";
	echo form_text('', 'user_admin_password', 'user_admin_password', '', array('password' => 1, 'required' => 1,
																			   'error_text' => $locale['460b']));
	echo "</td>\n</tr>\n<tr>\n";

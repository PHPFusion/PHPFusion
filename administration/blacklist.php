<?php
    ...
    if ((isset($_GET['action']) && $_GET['action'] == "delete") && (isset($_GET['blacklist_id']) && isnum($_GET['blacklist_id']))) {
        ...
        echo "<th class='tbl'>\n";
        echo form_text('', 'blacklist_ip', 'blacklist_ip', $blacklist_ip);
        echo "</td>\n</tr>\n<tr>\n";
        echo "<td class='tbl'><label for='blacklist_email'>".$locale['442']." <span class='required'>*</span></label></td>\n";
        echo "<td class='tbl'>\n";
        echo form_text('', 'blacklist_email', 'blacklist_email', $blacklist_email, array('email' => 1, 'error_text' => $locale['405']));
        echo "</tr>\n<tr>\n";
        echo "<td valign='top' class='tbl'><label for='blacklist_reason'>".$locale['443']."</label></td>\n";
        echo "<td class='tbl'>\n";
        echo form_textarea('', 'blacklist_reason', 'blacklist_reason', $blacklist_reason);
        echo "</td>\n</tr>\n<tr>\n";
        echo "<td align='center' colspan='2' class='tbl'><br />\n";
        echo form_button($locale['444'], 'blacklist_user', 'blacklist_user', $locale['444'], array('class' => 'btn-primary'));
        echo "</td>\n</tr>\n</tbody>\n</table>\n</form>\n";
        closetable();

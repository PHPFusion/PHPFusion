...
openside('');
echo form_select('captcha', $locale['693'], $Security_settings['captcha'], [
...
echo form_text('recaptcha_private', $locale['grecaptcha_0101'], $Security_settings['recaptcha_private'], [
    'inline'      => TRUE,
...
echo form_select('maintenance_level', $locale['675'], $Security_settings['maintenance_level'], [
    'options' => $level_array,
    'inline'  => TRUE,
    'width'   => '100%'
]);
$opts = ['1' => $locale['on'], '0' => $locale['off']];
echo form_select('maintenance', $locale['657'], $Security_settings['maintenance'], [
    'options' => $opts,
    'inline'  => TRUE,
    'width'   => '100%'
]);
echo form_textarea('maintenance_message', $locale['658'], $Security_settings['maintenance_message'], ['autosize' => TRUE]);
closeside();
openside('');
echo form_textarea('privacy_policy', $locale['820'], $Security_settings['privacy_policy'], [
    'autosize'  => 1,
...
echo form_select('bad_words_enabled', $locale['659'], $Security_settings['bad_words_enabled'], ['options' => $yes_no_array]);
echo form_text('bad_word_replace', $locale['654'], $Security_settings['bad_word_replace']);
echo form_textarea('bad_words', $locale['651'], $Security_settings['bad_words'], [
...
echo form_select('allow_php_exe', $locale['694'], $Security_settings['allow_php_exe'], ['options' => $yes_no_array]);
closeside();
echo "</div>\n</div>\n";

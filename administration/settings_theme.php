...
echo form_select('theme', $locale['418'], $opts, $settings_theme['theme'], array('callback_check' => 'theme_exists', 'inline'=>1, 'error_text' => $locale['error_invalid_theme'], 'width' => '100%'));
...
echo form_select('admin_theme', $locale['418a'], $opts, $settings_theme['admin_theme'], array('inline'=>1, 'error_text' => $locale['error_value'], 'width' => '100%'));

...
class eShop {
	...
	public function __construct() {
		...
		$this->pages = array('main' => array('title' => $locale['ESHP202'], 'file' => ADMIN."eshop/products.php"),
			...
			'orders' => array('title' => $locale['ESHP209']."<span class='badge m-l-10'>".$countorders."</span>",
				'file' => ADMIN."eshop/orders.php"));
		add_to_jquery("

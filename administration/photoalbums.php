<?php
    ...
    if (function_exists('gd_info')) {
        ...
        echo "<td class='tbl'>\n";
        echo form_text('', 'album_title', 'album_title', $album_title, array('max_length' => 100, 'required' => 1, 'error_text' => $locale['409']));
        echo "</td>\n</tr>\n";
        ...
        echo "<td class='tbl'>\n";
        echo form_select('', 'album_access', 'album_access', $access_opts, $album_access, array('placeholder' => 1, 'class' => 'pull-left m-r-10'));
        echo "</td>\n";
        echo "</tr>\n<tr>\n";

...
if (str_replace(".", "", $settings['version']) < "70300") {
	...
	if (file_exists(CLASSES."SubCats.class.php")) { echo "<span style='color:red;'>includes/classes/SubCats.class.php </span> need to be deleted<br />"; }
	...
	if (file_exists(BASEDIR."readarticle.php")) { echo "<span style='color:red;'>readarticle.php </span> need to be deleted<br />"; }
	echo "</div></div><br />\n";

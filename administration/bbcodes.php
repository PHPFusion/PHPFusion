...
function bbcode_list() {
    ...
    if (dbrows($result)) {
        ...
        echo '<h4>'.$locale['BBCA_402'].' <span><a class="btn btn-default m-l-20" href="'.clean_request('new=sep', ['new'], FALSE).'">Add Seperator</a></span></h4>';
        ...
        echo "<table id='$fusion_table_id' class='table table-hover table-striped'><thead><tr>";
        echo "<th></th>";
        ...
        while ($data = dbarray($result)) {
            ...
            if (file_exists(INCLUDES."bbcodes/".$data['bbcode_name']."_bbcode_include_var.php")) {
                ...
                $bbcode_image = '';
                //$img_path = __DIR__.'/../includes/bbcodes/images/'; // why do we do this?
                ...
                $bbcode_image = '';
                $bbcode_desc = 'Seperator';
                $bbcode_usage = 'Seperator for Grouping BBcode Buttons';
            }

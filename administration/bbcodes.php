...
if ($_GET['page'] == 1) {
	...
	echo "<td class='tbl'>\n";
	echo form_textarea($locale['418a'], 'test_message', 'test_message', $test_message, array('required' => 1,
																							 'error_text' => $locale['418b'],
																							 'bbcode' => 1));
	echo "</td>\n</tr>\n<tr>\n";
	...
	echo form_button($locale['401'], 'post_test', 'post_test', $locale['401'], array('class' => 'btn-primary'));
	echo "</td>\n</tr>\n</table>\n</form>\n";
	closetable();
}

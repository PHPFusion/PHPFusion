...
if (!empty($result)) {
    ...
    if ((isset($_GET['action']) && $_GET['action'] == "delete") && (isset($_GET['download_id']) && isnum($_GET['download_id']))) {
    ...
    } else if (isset($_POST['save_download'])) {
        $error = 0;
        ...
        if (isset($_POST['del_upload']) && isset($_GET['download_id']) && isnum($_GET['download_id'])) {
            ...
            $download_file = "";
            $download_filesize = "";
        } else if (!empty($_FILES['download_file']['name']) && is_uploaded_file($_FILES['download_file']['tmp_name'])) {
            $download_url = "";
        ...
        } else if (isset($_POST['download_file']) && $_POST['download_file'] != "") {
            $download_file = $_POST['download_file'];
        } else if ((isset($_POST['download_url']) && $_POST['download_url'] != "")) {
        ...
        if (isset($_POST['del_image']) && isset($_GET['download_id']) && isnum($_GET['download_id'])) {
            ...
            $download_image = "";
            $download_image_thumb = "";
        } else if (!empty($_FILES['download_image']['name']) && is_uploaded_file($_FILES['download_image']['tmp_name'])) {
            require_once INCLUDES."infusions_include.php";
        ...
        } else if (isset($_POST['download_image']) && $_POST['download_image'] != "") {
    ...
    if ($settings['download_screenshot']) {
        ...
        if (!empty($download_image) && !empty($download_image_thumb)) {
            echo "<img src='".DOWNLOADS."images/".$download_image_thumb."' alt='img' /><br />\n";

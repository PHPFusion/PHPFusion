...
echo form_text('siteusername', $locale['406'], $settings_main['siteusername'], array('max_length' => 32,
	...
	'error_text' => $locale['error_value'],
	'inline' => 1));
echo form_text('sitebanner', $locale['404'], $settings_main['sitebanner'], array('required' => 1,
	'error_text' => $locale['error_value'],
	'inline' => 1));
closeside();
openside('');
...
echo form_select('default_search', $locale['419'], $settings_main['default_search'], array('options' => $search_opts,
	'width' => '100%'));
closeside();
openside('');
...
echo form_select('site_protocol', $locale['426'], $settings_main['site_protocol'], array('options' => $opts,
	'regex' => 'http(s)?',
	'width' => '100%',
	'error_text' => $locale['error_value']));
echo form_text('site_host', $locale['427'], $settings_main['site_host'], array('max_length' => 255,
	'required' => 1,
	'error_text' => $locale['error_value']));
echo form_text('site_path', $locale['429'], $settings_main['site_path'], array('regex' => '\/([a-z0-9-_]+\/)*?',
	'max_length' => 255,
	'required' => 1));
...
openside('');
echo form_text('opening_page', $locale['413'], $settings_main['opening_page'], array('inline' => 1,
	'max_length' => 100,
	'required' => 1,
	'error_text' => $locale['error_value']));

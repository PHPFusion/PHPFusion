<?php
    ...
    echo "<td width='65%' class='tbl'>\n";
    echo form_text('', 'username', 'username', $settings2['siteusername'], array('max_length' => 32, 'required' => 1, 'error_text' => $locale['error_value']));
    echo "</td>\n</tr>\n<tr>\n";
    ...
    echo form_select('', 'site_protocol', 'site_protocol', $opts, $settings2['site_protocol'], array('required' => 1, 'error_text' => $locale['error_value']));
    echo "</td>\n</tr>\n<tr>\n";
    ...
    echo form_text('', 'site_host', 'site_host', $settings2['site_host'], array('max_length' => 255, 'required' => 1, 'error_text' => $locale['error_value']));
    echo "</td>\n</tr>\n<tr>\n";
    ...
    echo "<td width='65%' class='tbl' valign='top'>\n";
    echo form_text('', 'site_path', 'site_path', $settings2['site_path'], array('max_length' => 255, 'required' => 1, 'error_text' => $locale['error_value']));
    echo "</td>\n</tr>\n<tr>\n";
    ...
    echo "<td width='65%' class='tbl' valign='top'>\n";
    echo form_text('', 'site_port', 'site_port', $settings2['site_port'], array('max_length' => 4, 'required' => 1, 'error_text' => $locale['error_value']));
    echo "</td>\n</tr>\n<tr>\n";
    ...
    echo form_select('', 'bootstrap', 'bootstrap', $opts, $settings2['bootstrap'], array("required" => 1, 'error_text' => $locale['error_value']));
    echo "</td>\n</tr>\n<tr>\n";

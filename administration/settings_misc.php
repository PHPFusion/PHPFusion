...
echo form_select('tinymce_enabled', $locale['662'], fusion_get_settings("tinymce_enabled"), array(
    'options' => $choice_arr,
    'inline' => TRUE
));
closeside();
openside('');
echo form_text('smtp_host', $locale['664']."<br/>", $settings['smtp_host'], array(
    'max_length' => 200,
    'inline' => TRUE
));
...
echo form_select('smtp_auth', $locale['698'], $settings['smtp_auth'], array(
    'options' => $choice_arr,
    'inline' => TRUE
));
echo form_text('smtp_username', $locale['666'], $settings['smtp_username'], array(
    'max_length' => 100,
    'inline' => TRUE
));
echo form_text('smtp_password', $locale['667'], $settings['smtp_password'], array(
    'max_length' => 100,
    'inline' => TRUE
));
closeside();
...
echo form_select('rendertime_enabled', $locale['688'], fusion_get_settings("rendertime_enabled"), array(
    'options' => $opts,
    'inline' => TRUE
));
closeside();
...
echo form_select('mime_check', $locale['699f'], fusion_get_settings("mime_check"), array(
    'options' => $choice_arr,
    'width' => '100%'
));
...
echo form_select('ratings_enabled', $locale['672'], fusion_get_settings("ratings_enabled"), array(
    'options' => $choice_arr,
    'width' => '100%'
));
echo form_select('visitorcounter_enabled', $locale['679'], fusion_get_settings("visitorcounter_enabled"), array(
    'options' => $choice_arr,
    'width' => '100%'
));
echo form_select('create_og_tags', $locale['1030'], fusion_get_settings("create_og_tags"), array(
    'options' => $choice_arr,
    'width' => '100%'
));
closeside();
openside('');
echo form_select('index_url_bbcode', $locale['1031'], fusion_get_settings("index_url_bbcode"), array(
    'options' => $choice_arr,
    'width' => '100%'
));
echo form_select('index_url_userweb', $locale['1032'], fusion_get_settings("index_url_userweb"), array(
    'options' => $choice_arr,
    'width' => '100%'
));
closeside();

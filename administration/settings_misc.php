...
echo form_select('tinymce_enabled', $locale['662'], $choice_arr, $settings['tinymce_enabled'], array('inline'=>1, 'width'=>'100%'));
closeside();
openside('');
...
echo form_select('smtp_auth', $locale['698'], $choice_arr, $settings['smtp_auth'], array('inline'=>1, 'width'=>'100%'));
...
echo form_select('rendertime_enabled', $locale['688'], $opts, $settings['rendertime_enabled'], array('inline'=>1, 'width' => '100px'));
closeside();

...
if (isset($_POST['preview'])) {
	...
	if ($poll_title) {
		...
		echo form_button($locale['430'], 'blank', 'blank', $locale['430'], array('type' => 'button',
...
if (multilang_table("PO")) {
	...
	echo "<td class='tbl'>\n";
	echo form_select('', 'poll_language', 'poll_language', $language_opts, $poll_language, array('placeholder' => $locale['choose']));
	echo "</td>\n</tr>\n";
} else {

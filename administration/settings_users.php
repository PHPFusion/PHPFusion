...
echo "<td class='tbl'>\n";
echo form_text('', 'deactivation_period', 'deactivation_period', $settings['deactivation_period'], array('max_length' => 3,
																										 'width' => '100px',
																										 'number' => 1));
...
echo "<td class='tbl'>\n";
echo form_text('', 'deactivation_response', 'deactivation_response', $settings['deactivation_response'], array('max_length' => 3,
																											   'width' => '100px',
																											   'number' => 1));
...
echo form_text('', 'avatar_width', 'avatar_width', $settings['avatar_width'], array('class' => 'pull-left',
																					'max_length' => 3, 'number' => 1));
echo "<i class='entypo icancel pull-left m-r-10 m-l-10 m-t-10'></i>\n";
echo form_text('', 'avatar_height', 'avatar_height', $settings['avatar_height'], array('class' => 'pull-left',
																					   'max_length' => 3,
																					   'number' => 1));
echo "</td>\n</tr>\n<tr>\n";

...
$user = "";
$userField = "";
$orderbyArray = array($locale['102'] => "userlog_timestamp", $locale['103'] => "user_name",
...
echo form_select('', 'orderby', 'orderby', orderbyOptions(), $orderby, array('placholder' => $locale['choose'],
...
echo "<td class='tbl1'>\n";
echo form_select('', 'userField', 'userField', userFieldOptions(), $userField, array('placeholder' => $locale['choose'],
																					 'allowclear' => 1));
echo "</tr>\n<tr>\n";
...
echo "<td class='tbl1' align='right'>\n";
echo form_text('', 'delete', 'delete', '', array('max_length' => 3, 'number' => 1, 'placeholder' => $locale['111'],
												 'inline' => 1, 'width' => '100px'));
echo form_button($locale['109'], 'submit', 'submit', $locale['109'], array('class' => 'btn-primary'));
echo "</td>\n";
echo "</tr>\n";
echo "</tbody>\n</table>\n";

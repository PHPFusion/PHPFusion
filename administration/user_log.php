...
if ( !defined( 'FUSION_NULL' ) ) {
    ...
    if ( $rows ) {
        ...
        while ( $data = dbarray( $result ) ) {
            $delete_link = clean_request( $get_string . "&delete=" . $data['userlog_id'], ['section', 'ref', 'action', 'blacklist_id'], FALSE );
            echo "<tr>";
            ...
            echo "<td><a href='" . $delete_link . "' onclick=\"return confirm('" . $locale['UL_021'] . "');\">" . $locale['delete'] . "</a></td>\n";
            echo "</tr>\n";
        }

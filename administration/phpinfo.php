	...
	if ($_GET['page'] == 2) {
		...
		if ($_GET['page'] == 3) {
			...
			$folders = array(//path => have to be writeable or not
							 'administration/db_backups/' => TRUE, 'images/' => TRUE, 'images/imagelist.js' => TRUE,
							 'images/articles/' => TRUE, 'images/avatars/' => TRUE, 'images/news/' => TRUE,
							 'images/news/thumbs/' => TRUE, 'images/news_cats/' => TRUE, 'images/photoalbum/' => TRUE,
							 'images/photoalbum/submissions/' => TRUE, 'forum/attachments/' => TRUE,
							 'ftp_upload/' => TRUE, 'downloads/' => TRUE, 'downloads/images' => TRUE,
							 'robots.txt' => TRUE, 'config.php' => FALSE);

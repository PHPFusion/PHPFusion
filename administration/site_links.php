...
echo "<td class='tbl'>\n";
echo form_text('', 'link_name', 'link_name', $link_name, array('max_length' => 100, 'required' => 1,
															   'error_text' => $locale['461']));
echo "</td>\n</tr>\n";
...
echo "<td class='tbl'>\n";
echo form_select('', 'link_visibility', 'link_visibility', $visibility_opts, $link_visibility, array('placeholder' => $locale['choose'],
																									 'class' => 'pull-left'));
echo form_text($locale['423'], 'link_order', 'link_order', $link_order, array('number' => 1, 'class' => 'pull-left',
																			  'inline' => 1));
echo "</td>\n</tr>\n<tr>\n";

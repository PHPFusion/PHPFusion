...
echo "<td class='tbl1'>\n";
echo form_text('', 'template_sender_name', 'template_sender_name', $template_sender_name, array('required' => 1,
...
echo "<td class='tbl1'>\n";
echo form_text('', 'template_sender_email', 'template_sender_email', $template_sender_email, array('required' => 1,

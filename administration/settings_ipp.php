<?php
    ...
    echo form_text('', 'newsperpage', 'newsperpage', $settings2['newsperpage'], array('required' => 1, 'error_text' => $locale['error_value'], 'number' => 1, 'width' => '200px'));
    echo "</td>\n</tr>\n<tr>\n";
    echo "<td width='50%' class='tbl'><label for='articles_per_page'>".$locale['910'].":</label> <span class='required'>*</span></td>\n";
    echo "<td width='50%' class='tbl'>\n";
    echo form_text('', 'articles_per_page', 'articles_per_page', $settings2['articles_per_page'], array('required' => 1, 'error_text' => $locale['error_value'], 'number' => 1, 'width' => '200px'));
    echo "</td>\n</tr>\n<tr>\n";
    echo "<td width='50%' class='tbl'><label for='downloads_per_page'>".$locale['911'].":</label> <span class='required'>*</span></td>\n";
    echo "<td width='50%' class='tbl'>\n";
    echo form_text('', 'downloads_per_page', 'downloads_per_page', $settings2['downloads_per_page'], array('required' => 1, 'error_text' => $locale['error_value'], 'number' => 1, 'width' => '200px'));
    echo "</td>\n</tr>\n<tr>\n";
    echo "<td width='50%' class='tbl'><label for='links_per_page'>".$locale['912'].":</label> <span class='required'>*</span></td>\n";
    echo "<td width='50%' class='tbl'>\n";
    echo form_text('', 'links_per_page', 'links_per_page', $settings2['links_per_page'], array('required' => 1, 'error_text' => $locale['error_value'], 'number' => 1, 'width' => '200px'));
    echo "</tr>\n<tr>\n";
    echo "<td width='50%' class='tbl'><label for='comments_per_page'>".$locale['913'].":</label> <span class='required'>*</span></td>\n";
    echo "<td width='50%' class='tbl'>\n";
    echo form_text('', 'comments_per_page', 'comments_per_page', $settings2['comments_per_page'], array('required' => 1, 'error_text' => $locale['error_value'], 'number' => 1, 'width' => '200px'));
    echo "</td>\n</tr>\n<tr>\n";
    echo "<td width='50%' class='tbl'><label for='threads_per_page'>".$locale['914'].":</label> <span class='required'>*</span></td>\n";
    echo "<td width='50%' class='tbl'>\n";
    echo form_text('', 'threads_per_page', 'threads_per_page', $settings2['threads_per_page'], array('required' => 1, 'error_text' => $locale['error_value'], 'number' => 1, 'width' => '200px'));
    echo "</td>\n</tr>\n<tr>\n";
    echo "<td width='50%' class='tbl'><label for='posts_per_page'>".$locale['915'].":</label> <span class='required'>*</span></td>\n";
    echo "<td width='50%' class='tbl'>\n";
    echo form_text('', 'posts_per_page', 'posts_per_page', $settings2['posts_per_page'], array('required' => 1, 'error_text' => $locale['error_value'], 'number' => 1, 'width' => '200px'));
    echo "</td>\n</tr>\n<tr>\n";

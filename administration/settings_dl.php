<?php
    ...
    echo form_select('', 'download_types[]', 'download_types', $mime_opts, $settings2['download_types'], array('error_text' => $locale['error_type'], 'placeholder' => $locale['choose'], 'multiple' => 1));
    echo "</td>\n</tr>\n<tr>\n";
    ...
    echo "<td width='50%' class='tbl'>\n";
    echo form_text('', 'download_thumb_max_w', 'download_thumb_max_w', $settings2['download_thumb_max_w'], array('max_length' => 3, 'number' => 1, 'required' => 1, 'error_text' => $locale['error_width'], 'width' => '140px', 'class' => 'pull-left m-r-10'));
    echo "<i class='entypo icancel pull-left m-r-10 m-t-10'></i>\n";
    echo form_text('', 'download_thumb_max_h', 'download_thumb_max_h', $settings2['download_thumb_max_h'], array('max_length' => 3, 'number' => 1, 'required' => 1, 'error_text' => $locale['error_height'], 'width' => '140px', 'class' => 'pull-left'));
    echo "</td>\n</tr>\n<tr>\n";

                ...
                for ($i = 0; $i < count($inf); $i++) {
                    ...
                    if ($inf[$i]['inf_status'] > 0) {
                        if ($inf[$i]['inf_status'] > 1) {
                            echo form_button($locale['401'], 'infuse', "infuse-$i", $locale['401'], array('class' => 'btn-info m-t-5 infuse', 'icon' => 'entypo magnet'));
                        } else {
                            echo form_button($locale['411'], 'defuse', "defuse-$i", $locale['401'], array('class' => 'btn-default m-t-5 defuse', 'icon' => 'entypo trash'));
                        }
                    } else {
                        echo form_button($locale['401'], 'infuse', "infuse-$i", $locale['401'], array('class' => 'btn-primary m-t-5 infuse', 'icon' => 'entypo install'));
                    }
                    echo "</td>\n";
                    echo "</tr>\n";
                    echo closeform();

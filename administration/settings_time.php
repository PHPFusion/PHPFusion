...
openside('');
echo form_select('shortdate', $locale['451'], $settings2['shortdate'], array(
    'options' => $date_opts,
    'placeholder' => $locale['455']
));
echo form_select('longdate', $locale['452'], $settings2['longdate'], array(
    'options' => $date_opts,
    'placeholder' => $locale['455']
));
echo form_select('forumdate', $locale['453'], $settings2['forumdate'], array(
    'options' => $date_opts,
    'placeholder' => $locale['455']
));
echo form_select('newsdate', $locale['457'], $settings2['newsdate'], array(
    'options' => $date_opts,
    'placeholder' => $locale['455']
));
echo form_select('subheaderdate', $locale['454'], $settings2['subheaderdate'], array(
    'options' => $date_opts,
    'placeholder' => $locale['455']
));
closeside();

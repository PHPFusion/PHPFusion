...
$contents = [
    ...
    'link'        => ( $admin_link ?? '' ),
    'title'       => $locale['682ML'],
    'description' => $locale['language_description'],
...
function pf_post() {
    ...
    if ( admin_post('savesettings') ) {
        ...
        $inputData = [
            ...
            "old_localeset"         => form_sanitizer($_POST['old_localeset'],
                                                      fusion_get_settings('locale'),
                                                      "old_localeset"),
...
function pf_view() {
    ...
    echo form_select('localeset', $locale['417'], $settings["localeset"], [
        'options' => fusion_get_enabled_languages(),
    ]);
    closeside();

    openside($locale['668ML'] . '<small>' . $locale['669ML'] . '</small>', TRUE);
    ...
    echo openform('cacheFrm', 'POST').closeform();

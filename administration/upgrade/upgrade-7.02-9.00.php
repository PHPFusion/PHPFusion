 ...
 */
// upgrade weblinks
upgrade_articles(); // <--- hold Ctrl+click link to edit.
upgrade_weblinks();
upgrade_downloads();
upgrade_news();
install_blog();
...
function upgrade_weblinks() {
	if (db_exists(DB_WEBLINK_CATS) && db_exists(DB_WEBLINKS)) {
		if (fusion_get_settings("version") < 9.0) {
			...
			$result = dbquery("ALTER TABLE ".DB_WEBLINK_CATS." ADD weblink_cat_language VARCHAR(50) NOT NULL DEFAULT '".fusion_get_settings("locale")."' AFTER weblink_cat_access");
			...
			// copy the previous settings into the new settings
			dbquery("INSERT INTO ".DB_SETTINGS_INF." (settings_name, settings_value, settings_inf) VALUES ('links_extended_required', '15', 'weblinks')");
			dbquery("INSERT INTO ".DB_SETTINGS_INF." (settings_name, settings_value, settings_inf) VALUES ('links_allow_submission', '15', 'weblinks')");
		}
	}
}
...
function upgrade_news() {
	...
	if (db_exists(DB_NEWS_CATS) && db_exists(DB_NEWS)) {
		...
		$result = dbquery("ALTER TABLE ".DB_NEWS." ADD news_language VARCHAR(50) NOT NULL DEFAULT '".fusion_get_settings("locale")."' AFTER news_allow_ratings");
		$result = dbquery("ALTER TABLE ".DB_NEWS_CATS." ADD news_cat_language VARCHAR(50) NOT NULL DEFAULT '".fusion_get_settings("locale")."' AFTER news_cat_image");
	}
}

function upgrade_faq() {
	$result = dbquery("ALTER TABLE ".DB_FAQ_CATS." ADD faq_cat_language VARCHAR(50) NOT NULL DEFAULT '".fusion_get_settings("locale")."' AFTER faq_cat_description");
}

function upgrade_forum() {
	if (db_exists(DB_FORUMS)) {
		$result = dbquery("ALTER TABLE ".DB_FORUM_RANKS." ADD rank_language VARCHAR(50) NOT NULL DEFAULT '".fusion_get_settings("locale")."' AFTER rank_apply");
		$result = dbquery("ALTER TABLE ".DB_FORUMS." ADD forum_language VARCHAR(50) NOT NULL DEFAULT '".fusion_get_settings("locale")."' AFTER forum_merge");
...
function upgrade_articles() {
	if (db_exists(DB_ARTICLES) && db_exists(DB_ARTICLE_CATS)) {
		$result = dbquery("ALTER TABLE ".DB_ARTICLE_CATS." ADD article_cat_language VARCHAR(50) NOT NULL DEFAULT '".fusion_get_settings("locale")."' AFTER article_cat_access");
...
function upgrade_gallery() {
	$result = dbquery("ALTER TABLE ".DB_PHOTO_ALBUMS." ADD album_language varchar(50) NOT NULL default '".fusion_get_settings("locale")."' AFTER album_datestamp");
...
function upgrade_downloads() {
	if (db_exists(DB_DOWNLOAD_CATS) && db_exists(DOWNLOADS)) {
		...
		$result = dbquery("ALTER TABLE ".DB_DOWNLOAD_CATS." ADD download_cat_language VARCHAR(50) NOT NULL DEFAULT '".fusion_get_settings("locale")."' AFTER download_cat_access");
...
function upgrade_poll() {
	$result = dbquery("ALTER TABLE ".DB_POLLS." ADD poll_language VARCHAR(50) NOT NULL DEFAULT '".fusion_get_settings("locale")."' AFTER poll_ended");
}
...
function upgrade_eshop() {
	...
	if (db_exists(DB_ESHOP)) {
		...
		$result = dbquery("ALTER TABLE ".DB_PREFIX."eshop ADD product_languages VARCHAR(200) NOT NULL DEFAULT '".fusion_get_settings("locale")."' AFTER keywords");
		$result = dbquery("ALTER TABLE ".DB_PREFIX."eshop_cats ADD cat_order MEDIUMINT(8) UNSIGNED NOT NULL AFTER status");
		$result = dbquery("ALTER TABLE ".DB_PREFIX."eshop_cats ADD cat_languages VARCHAR(200) NOT NULL DEFAULT '".fusion_get_settings("locale")."' AFTER cat_order");
...
function upgrade_custom_page() {
	...
	$result = dbquery("ALTER TABLE ".DB_CUSTOM_PAGES." ADD page_language VARCHAR(255) NOT NULL DEFAULT '".fusion_get_settings("locale")."' AFTER page_allow_ratings");
}

function upgrade_panels() {
	$result = dbquery("ALTER TABLE ".DB_PANELS." ADD panel_languages VARCHAR(200) NOT NULL DEFAULT '.".fusion_get_settings("locale")."' AFTER panel_restriction");
}

function upgrade_site_links() {
	$result = dbquery("ALTER TABLE ".DB_SITE_LINKS." ADD link_language VARCHAR(50) NOT NULL DEFAULT '".fusion_get_settings("locale")."' AFTER link_order");
...
function upgrade_user_table() {
	...
	$result = dbquery("ALTER TABLE ".DB_USERS." ADD user_language VARCHAR(50) NOT NULL DEFAULT '".fusion_get_settings("locale")."'");
...
function upgrade_multilang() {
	...
	dbquery("
						...
						user_language VARCHAR(50) NOT NULL DEFAULT '".fusion_get_settings("locale")."',
						user_datestamp INT(10) NOT NULL default '0'
						) ENGINE=MyISAM DEFAULT CHARSET=UTF8 COLLATE=utf8_unicode_ci;
						");
	// Enabled languages array
	$result = dbquery("INSERT INTO ".DB_PREFIX."settings (settings_name, settings_value) VALUES ('enabled_languages', '".fusion_get_settings("locale")."')");
...
function install_email_templates() {
	...
	if ($result) {
		$result = dbquery("INSERT INTO ".DB_PREFIX."email_templates (template_id, template_key, template_format, template_active, template_name, template_subject, template_content, template_sender_name, template_sender_email, template_language) VALUES ('', 'PM', 'html', '0', '".$locale['T101']."', '".$locale['T102']."', '".$locale['T103']."', '".fusion_get_settings("siteusername")."', '".fusion_get_settings("siteemail")."', '".fusion_get_settings("locale")."')");
		$result = dbquery("INSERT INTO ".DB_PREFIX."email_templates (template_id, template_key, template_format, template_active, template_name, template_subject, template_content, template_sender_name, template_sender_email, template_language) VALUES ('', 'POST', 'html', '0', '".$locale['T201']."', '".$locale['T202']."', '".$locale['T203']."', '".fusion_get_settings("siteusername")."', '".fusion_get_settings("siteemail")."', '".fusion_get_settings("locale")."')");
		$result = dbquery("INSERT INTO ".DB_PREFIX."email_templates (template_id, template_key, template_format, template_active, template_name, template_subject, template_content, template_sender_name, template_sender_email, template_language) VALUES ('', 'CONTACT', 'html', '0', '".$locale['T301']."', '".$locale['T302']."', '".$locale['T303']."', '".fusion_get_settings("siteusername")."', '".fusion_get_settings("siteemail")."', '".fusion_get_settings("locale")."')");
	}

...
if ($counter != 0 && ($counter % 1 == 0)) echo "</tr>\n<tr>\n";
	...
	echo "<td class='tbl' align='center' valign='middle' width='1%'>&nbsp;&nbsp;<a href='".BASEDIR."eshop/eshop.php?details=".$data['prid']."'><img src='".($data['cimage'] ? "".checkeShpImageExists(BASEDIR."eshop/pictures/".$data['cimage']."")."" : "".BASEDIR."eshop/img/nopic_thumb.gif")."' alt='' width='40' border='0' /></a></td>";

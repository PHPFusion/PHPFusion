...
if (isset($_POST['uninstall'])) {
	...
	$result = dbquery("DROP TABLE IF EXISTS ".$db_prefix."eshop_shippingitems");
	$result = dbquery("DROP TABLE IF EXISTS ".$db_prefix."eshop_payments");
	...
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_noppf'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_target'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_folderlink'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_selection'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_cookies'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_bclines'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_icons'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_statustext'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_closesamelevel'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_inorder'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_shopmode'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_returnpage'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_ppmail'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_ipr'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_ratios'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_idisp_h'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_idisp_w'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_idisp_h2'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_idisp_w2'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_catimg_w'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_catimg_h'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_image_w'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_image_h'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_image_b'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_image_tw'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_image_th'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_image_t2w'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_image_t2h'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_buynow_color'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_checkout_color'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_cart_color'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_addtocart_color'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_info_color'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_return_color'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_pretext'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_pretext_w'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_listprice'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_currency'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_shareing'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_weightscale'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_vat'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_vat_default'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_terms'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_itembox_w'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_itembox_h'");
	$result = dbquery("DELETE FROM ".$db_prefix."settings WHERE settings_name='eshop_cipr'");
	...
	$result = dbquery("CREATE TABLE ".$db_prefix."eshop_photo_albums (
				...
				album_access char(4) not null default '0',

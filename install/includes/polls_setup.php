...
if (isset($_POST['uninstall'])) {
	...
	$result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('PO', 'polls.gif', '".$locale['setup_3022']."', 'infusions/member_poll_panel/member_poll_panel_admin.php', '1')");
	// panel

...
if (isset($_POST['uninstall'])) {
	...
	$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('site_path', '".(isset($url['path']) ? dirname($url['path']) : "")."')");
	...
	$result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('ESHP', 'eshop.gif', '".$locale['129d']."', 'settings_eshop.php', '4')");
	...
	for ($i = 0; $i < sizeof($_POST['enabled_languages']); $i++) {
		...
		$result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['129d']."', 'eshop.php', '0', '2', '0', '3', '".$enabled_languages[$i]."')");

...
if (isset($_POST['uninstall'])) {
	...
	$result = dbquery("CREATE TABLE ".$db_prefix."forums (
			...
			forum_poll TINYINT(4) NOT NULL DEFAULT '0',
			forum_vote TINYINT(4) NOT NULL DEFAULT '0',
			...
			forum_attach TINYINT(4) NOT NULL DEFAULT '0',
			forum_attach_download TINYINT(4) NOT NULL DEFAULT'0',

...
echo "<div class='well'>\n";
echo "<ol style='list-style:decimal !important;'>\n";
echo "<li><a href='".INFUSIONS."blog/blog.php?cat_id=0'>Uncategorized</a> -- <strong>This has some problem because 0 has no ID</strong></li>";
echo "<li><a href='".INFUSIONS."blog/blog.php?cat_id=0&amp;filter=false'>Uncategorized with Dummy Extra Request</a></li>";
echo "<li><a href='".INFUSIONS."blog/blog.php?cat_id=1'>Some category</a></li>";
echo "<li><a href='".INFUSIONS."blog/blog.php?cat_id=2'>Some category 2</a></li>";
echo "<li><a href='".INFUSIONS."blog/blog.php?cat_id=3'>Some category 3</a></li>";
echo "<li><a href='".INFUSIONS."blog/blog.php?cat_id=4'>Some category 4</a></li>";
echo "</ol>\n";
echo "</div>\n";

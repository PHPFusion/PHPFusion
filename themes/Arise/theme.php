...
function render_page($license = FALSE) {
    ...
    if ($settings['rendertime_enabled'] == 1 || ($settings['rendertime_enabled'] == 2 && iADMIN)) {
        echo "<td align='center' valign='top' width='65%'><div class='text-center'>".showrendertime()." - ".showMemoryUsage()."</div></td>\n";
    }
...
function openside($title, $collapse = FALSE, $state = "on") {
    ...
    echo "<table cellpadding='0' cellspacing='0' width='100%'>\n<tr>\n";
    echo "<td class='box box-caption'><div class='text-center'>".$title."</div></td>\n";
    if ($collapse == TRUE) {

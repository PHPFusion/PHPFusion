...
if (!function_exists('render_favicons')) {
    function render_favicons($folder = IMAGES) {
		...
		if (file_exists($folder)) {
            ...
            $html .= "<link rel='icon' type='image/png' href='".$folder."favicons/favicons-32x32.png' sizes='32x32'>\n";
            $html .= "<link rel='icon' type='image/png' href='".$folder."favicons/favicons-16x16.png' sizes='16x16'>\n";

        ...
        return c.each(function () {
            ...
            h = {
                initialize: function () {
                    ...
                    return h.is.enabled() ? void h.debug("Checkbox is already enabled") : (h.debug("Enabling checkbox"), h.set.enabled(), void g.onEnable.call(I))
                }, disable: function () {
                    return h.is.disabled() ? void h.debug("Checkbox is already disabled") : (h.debug("Disabling checkbox"), h.set.disabled(), void g.onDisable.call(I))
                }, get: {
                    radios: function () {
                        var n = h.get.name();

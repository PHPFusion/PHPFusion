...
openside('');
echo form_select('system_theme', $locale['POLARIS_200'], $settings['color_scheme'], ['options' => ['dark' => $locale['POLARIS_201'], 'light' => $locale['POLARIS_202'], 'auto'=> $locale['POLARIS_203']]]);

...
if (isset($_POST['step']) && $_POST['step'] == "4") {
    ...
    if ($db_host != "" && $db_user != "" && $db_name != "" && $db_prefix != "" && $db_driver != "") {
        ...
        if ($db_connect) {
                ...
                if ($can_write) {
                    ...
                    if (fwrite($temp, $config)) {
                        ...
                        $result = dbquery("CREATE TABLE ".$db_prefix."admin (
                            ...
                            admin_language VARCHAR(50) NOT NULL DEFAULT '".$_POST['localeset']."',
            ...
            /* No db select here has some issues with the all in one db call query.
        } else {
            echo "<div class='alert alert-danger'>\n";
...
if (isset($_POST['step']) && $_POST['step'] == "5") {
    ...
    if ($error_pass == "1" || $error_name == "1" || $error_mail == "1") {
        $field_class = ["", " tbl-error", " tbl-error", " tbl-error", " tbl-error", ""];
        if ($error_name == 1) {
            $field_class[0] = " tbl-error";
        }
        if ($error_mail == 1) {
...
if (isset($_POST['step']) && $_POST['step'] == "6") {
    ...
    if ($username == "") {
        ...
        $error_name = "1";
    } else if (!preg_match("/^[-0-9A-Z_@\s]+$/i", $username)) {
    ...
    if ($email == "") {
        ...
        $error_mail = "1";
    } else if (!preg_match("/^[-0-9A-Z_\.]{1,50}@([-0-9A-Z_\.]+\.){1,50}([0-9A-Z]){2,4}$/i", $email)) {
    ...
    if ($error == "") {
        if ($rows == 0) {
            ...
            $result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('bootstrap', '0')");
            ...
            $result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('theme', 'Atom-X8')");
            ...
            $result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('news_photo_max_w', '4800')");
            $result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('news_photo_max_h', '4600')");
            $result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('news_photo_max_b', '9990000')");
            ...
            $result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('download_screen_max_b', '9990000')");
            $result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('download_screen_max_w', '4800')");
            $result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('download_screen_max_h', '4600')");
            ...
            $result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('download_thumb_max_w', '200')");
            $result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('download_thumb_max_h', '200')");
            ...
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('AD', 'admins.png', '".$locale['080']."', 'administrators.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('APWR', 'admin_pass.png', '".$locale['128']."', 'admin_reset.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('AC', 'article_cats.png', '".$locale['081']."', 'article_cats.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('A', 'articles.png', '".$locale['082']."', 'articles.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('SB', 'banners.png', '".$locale['083']."', 'banners.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('BB', 'bbcodes.png', '".$locale['084']."', 'bbcodes.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('B', 'blacklist.png', '".$locale['085']."', 'blacklist.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('C', '', '".$locale['086']."', 'reserved', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('CP', 'c-pages.png', '".$locale['087']."', 'custom_pages.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('DB', 'db_backup.png', '".$locale['088']."', 'db_backup.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('DC', 'dl_cats.png', '".$locale['089']."', 'download_cats.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('D', 'dl.png', '".$locale['090']."', 'downloads.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('ERRO', 'errors.png', '".$locale['129']."', 'errors.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('FQ', 'faq.png', '".$locale['091']."', 'faq.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('F', 'forums.png', '".$locale['092']."', 'forums.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('IM', 'images.png', '".$locale['093']."', 'images.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('FM', 'file_manager.png', '".$locale['130d']."', 'file_manager.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('I', 'infusions.png', '".$locale['094']."', 'infusions.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('IP', '', '".$locale['095']."', 'reserved', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('M', 'members.png', '".$locale['096']."', 'members.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('NC', 'news_cats.png', '".$locale['097']."', 'news_cats.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('N', 'news.png', '".$locale['098']."', 'news.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('BLC', 'blog_cats.png', '".$locale['130a']."', 'blog_cats.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('BLOG', 'blog.png', '".$locale['130b']."', 'blog.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('S13', 'settings_blog.png', '".$locale['130c']."', 'settings_blog.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('P', 'panels.png', '".$locale['099']."', 'panels.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('PH', 'photoalbums.png', '".$locale['100']."', 'photoalbums.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('PI', 'phpinfo.png', '".$locale['101']."', 'phpinfo.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('PO', 'polls.png', '".$locale['102']."', 'polls.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('SL', 'site_links.png', '".$locale['104']."', 'site_links.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('SM', 'smileys.png', '".$locale['105']."', 'smileys.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('SU', 'submissions.png', '".$locale['106']."', 'submissions.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('PL', 'permalinks.png', '".$locale['129d']."', 'permalinks.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('U', 'upgrade.png', '".$locale['107']."', 'upgrade.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('UG', 'user_groups.png', '".$locale['108']."', 'user_groups.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('WC', 'wl_cats.png', '".$locale['109']."', 'weblink_cats.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('W', 'wl.png', '".$locale['110']."', 'weblinks.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('S1', 'settings.png', '".$locale['111']."', 'settings_main.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('S2', 'settings_time.png', '".$locale['112']."', 'settings_time.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('S3', 'settings_forum.png', '".$locale['113']."', 'settings_forum.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('S4', 'registration.png', '".$locale['114']."', 'settings_registration.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('S5', 'photoalbums.png', '".$locale['115']."', 'settings_photo.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('S6', 'settings_misc.png', '".$locale['116']."', 'settings_misc.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('S7', 'settings_pm.png', '".$locale['117']."', 'settings_messages.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('S8', 'settings_news.png', '".$locale['121']."', 'settings_news.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('S9', 'settings_users.png', '".$locale['122']."', 'settings_users.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('S10', 'settings_ipp.png', '".$locale['124']."', 'settings_ipp.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('S11', 'settings_dl.png', '".$locale['123']."', 'settings_dl.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('S12', 'security.png', '".$locale['125']."', 'settings_security.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('UF', 'user_fields.png', '".$locale['118']."', 'user_fields.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('FR', 'forum_ranks.png', '".$locale['119']."', 'forum_ranks.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('UFC', 'user_fields_cats.png', '".$locale['120']."', 'user_field_cats.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('UL', 'user_log.png', '".$locale['129a']."', 'user_log.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('ROB', 'robots.png', '".$locale['129b']."', 'robots.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('MAIL', 'email.png', '".$locale['T001']."', 'email.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('LANG', 'languages.png', '".$locale['129c']."', 'settings_languages.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('MI', 'migration.png', '".$locale['129e']."', 'migrate.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page, admin_language) VALUES ('S14', 'settings_theme.png', '".$locale['129f']."', 'settings_theme.php', '4', '".$_POST['localeset']."')");
            ...
            $result = dbquery("INSERT INTO ".$db_prefix."panels (panel_name, panel_filename, panel_content, panel_side, panel_order, panel_type, panel_access, panel_display, panel_status, panel_url_list) VALUES ('".$locale['162']."', 'forum_threads_panel', '', '1', '3', 'file', '0', '0', '1', '')");
            $result = dbquery("INSERT INTO ".$db_prefix."panels (panel_name, panel_filename, panel_content, panel_side, panel_order, panel_type, panel_access, panel_display, panel_status, panel_url_list) VALUES ('".$locale['163']."', 'latest_articles_panel', '', '1', '4', 'file', '0', '0', '1', '')");
            $result = dbquery("INSERT INTO ".$db_prefix."panels (panel_name, panel_filename, panel_content, panel_side, panel_order, panel_type, panel_access, panel_display, panel_status, panel_url_list) VALUES ('".$locale['164']."', 'welcome_message_panel', '', '5', '1', 'file', '0', '0', '1', '')");
            $result = dbquery("INSERT INTO ".$db_prefix."panels (panel_name, panel_filename, panel_content, panel_side, panel_order, panel_type, panel_access, panel_display, panel_status, panel_url_list) VALUES ('".$locale['165']."', 'forum_threads_list_panel', '', '1', '5', 'file', '0', '0', '0', '')");
            ...
            $result = dbquery("INSERT INTO ".$db_prefix."panels (panel_name, panel_filename, panel_content, panel_side, panel_order, panel_type, panel_access, panel_display, panel_status, panel_url_list) VALUES ('".$locale['168']."', 'rss_feeds_panel', '', '4', '2', 'file', '0', '0', '1', '')");
            $result = dbquery("INSERT INTO ".$db_prefix."panels (panel_name, panel_filename, panel_content, panel_side, panel_order, panel_type, panel_access, panel_display, panel_status, panel_url_list) VALUES ('".$locale['167']."', 'member_poll_panel', '', '4', '3', 'file', '0', '0', '0', '')");
            $result = dbquery("INSERT INTO ".$db_prefix."panels (panel_name, panel_filename, panel_content, panel_side, panel_order, panel_type, panel_access, panel_display, panel_status, panel_url_list) VALUES ('".$locale['169']."', 'blog_archive_panel', '', '4', '4', 'file', '1', '0', '0', '')");
            ...
            $result = dbquery("INSERT INTO ".$db_prefix."user_field_cats (field_cat_id, field_cat_name, field_cat_db, field_cat_index, field_cat_class, field_cat_page, field_cat_order) VALUES (3, '".$locale['222']."', '', '', '', 0, 3)");
            $result = dbquery("INSERT INTO ".$db_prefix."user_field_cats (field_cat_id, field_cat_name, field_cat_db, field_cat_index, field_cat_class, field_cat_page, field_cat_order) VALUES (4, '".$locale['223']."', '', '', '', 0, 4)");
            $result = dbquery("INSERT INTO ".$db_prefix."user_field_cats (field_cat_id, field_cat_name, field_cat_db, field_cat_index, field_cat_class, field_cat_page, field_cat_order) VALUES (5, '".$locale['224']."', '', '', '', 1, 5)");
            ...
            for ($i = 0; $i < sizeof($enabled_languages); $i++) {
                ...
                $result = dbquery("INSERT INTO ".$db_prefix."blog_cats (blog_cat_name, blog_cat_image, blog_cat_language) VALUES ('".$locale['190']."', 'news.gif', '".$enabled_languages[$i]."')");
            ...
            for ($i = 0; $i < sizeof($enabled_languages); $i++) {
                ...
                $result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['130b']."', 'blog.php', '0', '2', '0', '6', '".$enabled_languages[$i]."')");
                ...
                $result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['130a']."', 'blog_cats.php', '0', '2', '0', '8', '".$enabled_languages[$i]."')");
                $result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['137']."', 'weblinks.php', '0', '2', '0', '9', '".$enabled_languages[$i]."')");
                $result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['135']."', 'contact.php', '0', '1', '0', '10', '".$enabled_languages[$i]."')");
                $result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['138']."', 'photogallery.php', '0', '1', '0', '11', '".$enabled_languages[$i]."')");
                $result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['139']."', 'search.php', '0', '1', '0', '12', '".$enabled_languages[$i]."')");
                $result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('---', '---', '101', '1', '0', '13', '".$enabled_languages[$i]."')");
                $result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['140']."', 'submit.php?stype=l', '101', '1', '0', '14', '".$enabled_languages[$i]."')");
                $result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['141']."', 'submit.php?stype=n', '101', '1', '0', '15', '".$enabled_languages[$i]."')");
                $result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['142']."', 'submit.php?stype=a', '101', '1', '0', '16', '".$enabled_languages[$i]."')");
                $result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['143']."', 'submit.php?stype=p', '101', '1', '0', '17', '".$enabled_languages[$i]."')");

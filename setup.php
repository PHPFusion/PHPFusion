...
if (isset($_POST['step']) && $_POST['step'] == "6") {
    ...
    if ($error == "") {
        if ($rows == 0) {
            ...
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('AD', 'admins.png', '".$locale['080']."', 'administrators.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('APWR', 'admin_pass.png', '".$locale['128']."', 'admin_reset.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('AC', 'article_cats.png', '".$locale['081']."', 'article_cats.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('A', 'articles.png', '".$locale['082']."', 'articles.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('SB', 'banners.png', '".$locale['083']."', 'banners.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('BB', 'bbcodes.png', '".$locale['084']."', 'bbcodes.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('B', 'blacklist.png', '".$locale['085']."', 'blacklist.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('C', '', '".$locale['086']."', 'reserved', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('CP', 'c-pages.png', '".$locale['087']."', 'custom_pages.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('DB', 'db_backup.png', '".$locale['088']."', 'db_backup.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('DC', 'dl_cats.png', '".$locale['089']."', 'download_cats.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('D', 'dl.png', '".$locale['090']."', 'downloads.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('ERRO', 'errors.png', '".$locale['129']."', 'errors.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('FQ', 'faq.png', '".$locale['091']."', 'faq.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('F', 'forums.png', '".$locale['092']."', 'forums.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('IM', 'images.png', '".$locale['093']."', 'images.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('FM', 'file_manager.png', '".$locale['130d']."', 'file_manager.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('I', 'infusions.png', '".$locale['094']."', 'infusions.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('IP', '', '".$locale['095']."', 'reserved', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('M', 'members.png', '".$locale['096']."', 'members.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('NC', 'news_cats.png', '".$locale['097']."', 'news_cats.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('N', 'news.png', '".$locale['098']."', 'news.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('BLC', 'blog_cats.png', '".$locale['130a']."', 'blog_cats.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('BLOG', 'blog.png', '".$locale['130b']."', 'blog.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('S13', 'settings_blog.png', '".$locale['130c']."', 'settings_blog.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('P', 'panels.png', '".$locale['099']."', 'panels.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('PH', 'photoalbums.png', '".$locale['100']."', 'photoalbums.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('PI', 'phpinfo.png', '".$locale['101']."', 'phpinfo.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('PO', 'polls.png', '".$locale['102']."', 'polls.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('SL', 'site_links.png', '".$locale['104']."', 'site_links.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('SM', 'smileys.png', '".$locale['105']."', 'smileys.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('SU', 'submissions.png', '".$locale['106']."', 'submissions.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('PL', 'permalinks.png', '".$locale['129d']."', 'permalinks.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('U', 'upgrade.png', '".$locale['107']."', 'upgrade.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('UG', 'user_groups.png', '".$locale['108']."', 'user_groups.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('WC', 'wl_cats.png', '".$locale['109']."', 'weblink_cats.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('W', 'wl.png', '".$locale['110']."', 'weblinks.php', '1', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('S1', 'settings.png', '".$locale['111']."', 'settings_main.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('S2', 'settings_time.png', '".$locale['112']."', 'settings_time.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('S3', 'settings_forum.png', '".$locale['113']."', 'settings_forum.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('S4', 'registration.png', '".$locale['114']."', 'settings_registration.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('S5', 'photoalbums.png', '".$locale['115']."', 'settings_photo.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('S6', 'settings_misc.png', '".$locale['116']."', 'settings_misc.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('S7', 'settings_pm.png', '".$locale['117']."', 'settings_messages.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('S8', 'settings_news.png', '".$locale['121']."', 'settings_news.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('S9', 'settings_users.png', '".$locale['122']."', 'settings_users.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('S10', 'settings_ipp.png', '".$locale['124']."', 'settings_ipp.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('S11', 'settings_dl.png', '".$locale['127']."', 'settings_dl.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('S12', 'security.png', '".$locale['125']."', 'settings_security.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('UF', 'user_fields.png', '".$locale['118']."', 'user_fields.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('FR', 'forum_ranks.png', '".$locale['119']."', 'forum_ranks.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('UFC', 'user_fields_cats.png', '".$locale['120']."', 'user_field_cats.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('UL', 'user_log.png', '".$locale['129a']."', 'user_log.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('ROB', 'robots.png', '".$locale['129b']."', 'robots.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('MAIL', 'email.png', '".$locale['T001']."', 'email.php', '3', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('LANG', 'languages.png', '".$locale['129c']."', 'settings_languages.php', '4', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('MI', 'migration.png', '".$locale['129e']."', 'migrate.php', '2', '".$_POST['localeset']."')");
            $result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('S14', 'settings_theme.png', '".$locale['129f']."', 'settings_theme.php', '4', '".$_POST['localeset']."')");

...
if (isset($_POST['canceldelete'])) {
    redirect(BASEDIR."forum/viewthread.php?forum_id=".$_GET['forum_id']."&thread_id=".$_GET['thread_id']);
}
...
if (isset($_GET['step']) && $_GET['step'] == "renew") {
...
} else if (isset($_GET['step']) && $_GET['step'] == "delete") {
    ...
    echo "</div>\n";
    closetable();
} else if (isset($_GET['step']) && $_GET['step'] == "lock") {
    ...
    echo "<a href='".BASEDIR."forum/index.php'>".$locale['403']."</a><br /><br />\n</div>\n";
    closetable();
} else if (isset($_GET['step']) && $_GET['step'] == "unlock") {
    ...
    echo "<a href='".BASEDIR."forum/index.php'>".$locale['403']."</a><br /><br />\n</div>\n";
    closetable();
} else if (isset($_GET['step']) && $_GET['step'] == "sticky") {
    ...
    echo "<a href='".BASEDIR."forum/index.php'>".$locale['403']."</a><br /><br />\n</div>\n";
    closetable();
} else if (isset($_GET['step']) && $_GET['step'] == "nonsticky") {
    ...
    echo "<a href='".BASEDIR."forum/index.php'>".$locale['403']."</a><br /><br /></div>\n";
    closetable();
} else if (isset($_GET['step']) && $_GET['step'] == "move") {

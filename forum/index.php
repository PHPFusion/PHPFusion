<?php
    ...
    // == using ID as key
    echo opentabbody($tab_title['title'], $tab_active, $tab_active);
    ...
    function latest() {
        ...
        $opts = array('0' => 'All Results', '1' => '1 Day', '7' => '7 Days', '14' => '2 Weeks', '30' => '1 Month', '90' => '3 Months', '180' => '6 Months', '365' => '1 Year');

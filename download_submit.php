        ...
        if ( Defender::safe() ) {
            ...
            if ( $dl_settings['download_auto_approve'] ) {
                ...
                if ( !empty( $criteriaArray['download_file'] ) && file_exists( DOWNLOADS."submissions/".$criteriaArray['download_file'] ) ) {
                    ...
                    $temp_file = $criteriaArray['download_file'];
                    $criteriaArray['download_file'] = filename_exists( $dest, $criteriaArray['download_file'] );
                    copy( DOWNLOADS."submissions/".$temp_file, $dest.$criteriaArray['download_file'] );
                ...
                if ( !empty( $criteriaArray['download_image'] ) && file_exists( DOWNLOADS."submissions/images/".$criteriaArray['download_image'] ) ) {
                    ...
                    $temp_file = $criteriaArray['download_image'];
                    $criteriaArray['download_image'] = filename_exists( $dest, $criteriaArray['download_image'] );
                    copy( DOWNLOADS."submissions/images/".$temp_file, $dest.$criteriaArray['download_image'] );
                ...
                if ( !empty( $criteriaArray['download_image_thumb'] ) && file_exists( DOWNLOADS."submissions/images/".$criteriaArray['download_image_thumb'] ) ) {
                    $dest = DOWNLOADS."images/";
                    $temp_file = $criteriaArray['download_image_thumb'];
                    $criteriaArray['download_image_thumb'] = filename_exists( $dest, $criteriaArray['download_image_thumb'] );
                    copy( DOWNLOADS."submissions/images/".$temp_file, $dest.$criteriaArray['download_image_thumb'] );

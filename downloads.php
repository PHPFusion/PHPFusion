...
if (!isset($_GET['download_id']) || !isnum($_GET['download_id'])) {
    ...
    if (dbrows($cat_list_result)) {
        ...
        if (isset($_GET['cat_id']) && isnum($_GET['cat_id']) && $_GET['cat_id'] != "all") {
            ...
            $order_by_allowed = ["download_id", "download_user", "download_count", "download_datestamp"];
...
if (isset($_GET['download_id']) && isnum($_GET['download_id'])) {
    ...
    if (dbrows($result)) {
        ...
        if ($data['download_allow_comments']) {
            showcomments("D", DB_DOWNLOADS, "download_id", $_GET['download_id'], BASEDIR."downloads.php?cat_id=".$data['download_cat']."&amp;download_id=".$_GET['download_id']);
        }
        if ($data['download_allow_ratings']) {
            showratings("D", $_GET['download_id'], BASEDIR."downloads.php?cat_id=".$data['download_cat']."&amp;download_id=".$_GET['download_id']);
        }
    }
}

        ...
        if (isset($_POST['delete']) && (isset($_GET['submit_id']) && isnum($_GET['submit_id']))) {
            ...
            if (dbrows($result) > 0) {
                ...
                $callback_data = [
                    ...
                    "download_description"       => parse_textarea($submit_criteria['download_description']),
                    "download_description_short" => parse_textarea($submit_criteria['download_description_short']),

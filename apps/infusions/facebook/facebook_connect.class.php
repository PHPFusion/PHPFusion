<?php
namespace PHPFusion\Infusions\Facebook;
...
class Facebook_Connect {
    ...
    public function displayField($field_value, array $options = []) {
        ...
        return '
        <div class="social-connector row">
            <label class="label-control col-xs-12 col-sm-3">'.$locale['fbc_0105'].'</label>
            <div class="col-xs-12 col-sm-9">
                <a class="btn btn-primary btn-rounded'.(!$login_url ? ' disabled' : '').'" href="'.$login_url.'"><span class="control-label display-inline">'.$icon.'</span>'.$text.'</a>                        
            </div>
        </div>
        ';
    ...
    function displaySettingsAdmin() {
        ...
        echo '
        <div class="'.grid_row().'">
        <div class="'.grid_col(100, 100, 70, 50).'">';

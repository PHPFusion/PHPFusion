...
namespace PHPFusion\Infusions\Profile_Home\Panels\Following;
...
class Following {
    ...
    public function viewFollowing() {
		...
		<p>Follow fellow fusioneers and get notified when they post something.</p>
        ...
        $follows_list = $relations->getUserFollowing( $this->data['user_id'] );

...
use PHPFusion\Infusions\Profile_Home\Panels\mpItems\mpItems;

function showMPItems( $data ) {
    $itemPanel = new mpItems( $data );
    ...
    return show_profile_panel( 'mpItems', 'Marketplace Items', $itemPanel->viewPanel(), $edit_link, $more_link );
}

fusion_add_hook( 'profile_home_panels', 'showMpItems' );

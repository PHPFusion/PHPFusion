...
class ForumAdminView extends ForumAdminInterface {
    ...
    private function moveUp() {
        ...
        if (isset($_GET['forum_id']) && isnum($_GET['forum_id'])
            ...
            add_notice('success', self::$locale['forum_notice_6'] . " " . sprintf(self::$locale['forum_notice_13'], $_GET['forum_id'], $_GET['order']));
    ...
    private function moveDown() {
        ...
        if (isset($_GET['forum_id']) && isnum($_GET['forum_id']) && isset($_GET['order']) && isnum($_GET['order'])) {
            ...
            if ($result) {
                add_notice('success', self::$locale['forum_notice_7'] . " " . sprintf(self::$locale['forum_notice_13'],

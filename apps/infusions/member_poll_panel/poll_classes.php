...
class MemberPoll {
    ...
    public function pollForm() {
        ...
        echo QuantumFields::multilocaleInput('poll_title', self::$locale['POLL_045'], $this->data['poll_title'], [
            'required'    => TRUE,
            'inline'      => FALSE,
        ...
        foreach ($this->data['poll_opt'] as $im1 => $data1) {
            $nam = "poll_opt_$im1";
            echo QuantumFields::multilocaleInput($nam, self::$locale['POLL_046'] . ' ' . $im1, $data1, [
                'required'    => TRUE,
                'inline'      => TRUE,

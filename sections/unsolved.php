...
$base_condition = (multilang_table("FO") ? "tf.forum_language='".LANGUAGE."' AND " : "")." tf.forum_type='4' AND t.thread_answered='0' AND t.thread_locked='0' AND t.thread_hidden='0' AND ".groupaccess('tf.forum_access');

...
$locale['status4'] = "Udelukket af sikkerheds&aring;rsager";
...
$locale['UM061b'] = "Brugernavn eller email";
$locale['UM062'] = "Kodeord";
$locale['UM063'] = "Husk mig";
$locale['UM064'] = "Log ind";
$locale['UM065'] = "Er du ikke bruger endnu?<br /><a href='".BASEDIR."register.php' class='side'>Klik her</a> for at oprette dig.";
$locale['UM066'] = "Har du glemt dit kodeord?<br />Bed om at f&aring; et nyt ved at klikke <a href='".BASEDIR."lostpassword.php' class='side'>her</a>.";
...
$locale['global_198'] = "<strong>Advarsel:</strong> INSTALLATIONSPROGRAMMERNE ER IKKE SLETTET. SLET FOLDEREN /INSTALL/ MED DET SAMME!";
$locale['global_199'] = "<strong>Advarsel:</strong> administratorkodeord er ikke oprettet. Klik p&aring; <a href='".BASEDIR."edit_profile.php'>Rediger profil</a> for at oprette det.";
//Titles
$locale['global_200'] = " - ";
$locale['global_201'] = ": ";
...
Udelukkelsen af din konto på ".fusion_get_settings('siteurl')." er blevet ophævet. Her er dine pålogningsoplysninger:\n
Brugernavn: USER_NAME
Kodeord: Skjult af sikkerhedsårsager\n
Hvis du har glemt dit kodeord kan du oprette et nyt ved at klikke på følgende link: LOST_PASSWORD\n\n
Venlig hilsen\n
".fusion_get_settings('siteusername');
$locale['global_453'] = "Hej USER_NAME\n
Udelukkelsen af din konto på; ".fusion_get_settings('siteurl')." er blevet ophævet.\n\n
Venlig hilsen\n
".fusion_get_settings('siteusername');
$locale['global_454'] = "Kontoen er genaktiveret på ".fusion_get_settings('sitename');
$locale['global_455'] = "Hej USER_NAME\n
Sidste gang du loggede på, blev din konto reaktiveret på ".fusion_get_settings('siteurl')." og du er ikke længere registreret som inaktiv.\n\n
Venlig hilsen\n
".fusion_get_settings('siteusername');
...
$locale['search'] = 'Søg';
$locale['help'] = 'Hjælp';
$locale['register'] = 'Opret ny bruger';
$locale['ban'] = 'Udeluk';
$locale['reactivate'] = 'Reaktiver';
$locale['user'] = 'Bruger';
$locale['promote'] = 'Anbefal';
$locale['show'] = 'Vis';
//Tables
...
$locale['parent'] = 'Opret en ny overkategori ...';
$locale['order'] = 'Rækkefølge';
$locale['status'] = 'Status';
$locale['note'] = 'Tag en note om dette';
...
$locale['fmt_item'] = "objekt|objekter";

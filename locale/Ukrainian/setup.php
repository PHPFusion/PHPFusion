...
// Step 1
$locale['setup_1000'] = "Будь ласка, виберіть необхідну мову:";
$locale['setup_1001'] = "Завантажити інші мови можна з <a href='https://www.php-fusion.co.uk/downloads.php#langpacks' target='_blank'>Офіційного сайту підтримки PHP-Fusion</a>";
$locale['setup_1002'] = "Вітаємо у режимі відновлення PHP-Fusion 9.0.";
$locale['setup_1003'] = "Виявлено вже встановлену систему.\r\nБудь ласка, виберіть одну із запропонованих дій для продовження.";
...
$locale['setup_1104'] = "Перевірка прав доступу відбулась із помилками, будь ласка, перевірте права (CHMOD) для файлів/каталогів з позначкою [Помилка].";
...
$locale['setup_3322'] = "Теми без відповді";
...
$locale['eshop']['description'] = "Електронна комерція";

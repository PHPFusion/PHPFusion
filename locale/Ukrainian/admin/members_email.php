...
Минуло ".fusion_get_settings('deactivation_period')." день(днів) з часу Вашого останнього візиту на сайт <<".fusion_get_settings('sitename').">>. Ваш обліковий запис позначено як бездіяльний, але уся інформація, пов'язана із ним, збережена і не зазнала змін.\n
...
[REASON].\n
Якщо бажаєте отримати детальну інформацію про це блокування, будь ласка, зв'яжіться з адміністрацією сайту з допомогою електронної пошти ".fusion_get_settings('siteemail').".\n
".fusion_get_settings('siteusername');
...
Ваш обліковий запис на сайті <<".fusion_get_settings('sitename').">> заблокував адміністратор ".$userdata['user_name']." через деякі Ваші особисті дії або дії пов`язані з Вашим обліковим записом, що потенційно становили загрозу безпеці сайту.\n
Якщо бажаєте отримати детальну інформацію про це блокування з міркувань безпеки, будь ласка, зв'яжіться з адміністрацією сайту з допомогою електронної пошти ".fusion_get_settings('siteemail').".\n
".fusion_get_settings('siteusername');
...
[REASON].\n
Якщо бажаєте отримати детальну інформацію про це призупинення, будь ласка, зв'яжіться з адміністрацією сайту з допомогою електронної пошти ".fusion_get_settings('siteemail').".\n
".fusion_get_settings('siteusername');
?>
<?php
$locale['setup_0000'] = "PHPFusion X Installer";
$locale['setup_0002'] = "Install PHPFusion X";
$locale['setup_0003'] = "A short guided setup for your server, database, and primary administrator. Need help? Read the <a class='strong' href='https://phpfusion.com/infusions/wiki/documentation.php?page_id=216' target='_blank' rel='noopener'>installation documentation</a>.";
...
$locale['setup_0020'] = "PHPFusion X Upgrade";
$locale['setup_0022'] = "Upgrade PHPFusion X";
$locale['setup_0023'] = "Review the server checks and database details before PHPFusion applies the upgrade. Your existing configuration is retained until you finish or exit safely.";
...
$locale['setup_1002'] = "PHPFusion X Recovery Mode";
...
$locale['setup_1021'] = "Recovery mode";
$locale['setup_1022'] = "Installer";
$locale['setup_1023'] = "Open recovery";
$locale['setup_1024'] = "Installation progress";
$locale['setup_1025'] = "Progress";
$locale['setup_1026'] = "Step %d of %d";
$locale['setup_1027'] = "Complete";
$locale['setup_1028'] = "Current";
$locale['setup_1029'] = "Pending";
$locale['setup_1030'] = "Build";
$locale['setup_1031'] = "PHPFusion X Installer";
$locale['setup_1032'] = "Secure local setup";
$locale['setup_1033'] = "Recover an interrupted upgrade";
$locale['setup_1034'] = "Review the detected installation, resume database work, or restore the site configuration without starting over.";
$locale['setup_1035'] = "Installed version";
$locale['setup_1036'] = "Target build";
$locale['setup_1037'] = "Configuration";
$locale['setup_1038'] = "Maintenance mode";
$locale['setup_1039'] = "No installer errors logged";
$locale['setup_1040'] = "Available";
$locale['setup_1041'] = "Missing or unreadable";
$locale['setup_1042'] = "Active";
$locale['setup_1043'] = "Inactive";
$locale['setup_1044'] = "Latest error log";
$locale['setup_1045'] = "This upgrade can be resumed";
$locale['setup_1046'] = "Repair the current build";
$locale['setup_1047'] = "Danger zone";
$locale['setup_1048'] = "Confirm that you understand the reset will permanently remove the PHPFusion tables.";
$locale['setup_1049'] = "The reset did not remove every core table. Review the database before continuing.";
$locale['setup_1050'] = "PHPFusion will repeat its requirements check, reconcile the schema, and continue the pending upgrade.";
$locale['setup_1051'] = "Use this when an upgrade reached the target version but stopped before all schema work completed.";
$locale['setup_1052'] = "Resume upgrade";
$locale['setup_1053'] = "Re-run current upgrade";
$locale['setup_1054'] = "Recovery tools";
$locale['setup_1055'] = "Choose only the action needed to restore access or finish configuration.";
$locale['setup_1056'] = "I have a verified backup and understand that this permanently deletes the PHPFusion database tables.";
$locale['setup_1057'] = "No recoverable installation found";
$locale['setup_1058'] = "Recovery mode needs a readable temporary configuration and a reachable PHPFusion database. Start a normal installation or restore your configuration backup first.";
$locale['setup_1059'] = "Return to installer";
// Step 2

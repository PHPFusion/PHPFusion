...
$locale['setup_0003'] = "The installer guide will guide you through the steps required to install PHP-Fusion CMS on your server. Should you need further assistance, please check our <a class='strong' href='https://phpfusion.com/infusions/wiki/documentation.php?page=216' target='_blank'>Online Installation Documentation</a>.";
$locale['setup_0005'] = " I have read and agreed to the PHP-Fusion <a href='https://www.phpfusion.com/licensing/licensing.php' target='_blank'>Terms and Conditions of Use</a>";
$locale['setup_0006'] = "PHP-Fusion 9 requires at least PHP 5.6.39. See the <a href='https://www.phpfusion.com/infusions/wiki/documentation.php?page=215'>system requirements</a> page for more information.";
...
$locale['setup_0113'] = "Your PHP installation is too old. PHP-Fusion requires at least a minimum of 7.2.5. PHP versions higher than 5.6.39 provide built-in SQL injection protection for mysql databases. It is recommended to update.";
...
$locale['setup_1001'] = "Download more locales from <a href='https://www.phpfusion.com/php_fusion_9_downloads.php' target='_blank'><strong>PHP-Fusion Official Support Site</strong></a>";

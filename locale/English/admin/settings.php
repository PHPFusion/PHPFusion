...
$locale['424'] = "Examples : <br />/FOLDER/* Takes all files and variables in the wanted directory.<br/> Wildcard: <br/> /forum/*<br/> Specific: <br/>/news.php<br/>/forum/index.php <br/> ";

...
$locale['datepicker'] = "default"; // refer to path locale/Lang/includes/dynamics/assets/flatpickr/l10n/{value}.js
...
$locale['user2.1'] = 'Student';

$locale['user2.2'] = 'Instructor';

$locale['user2.3'] = 'Teacher';
...
$locale['global_186'] = "You are now logged in";
...
$locale['result_locale'] = "Showing _START_ to _END_ of _TOTAL_ entries"; // Don't translate _PAGE_ and _PAGES_

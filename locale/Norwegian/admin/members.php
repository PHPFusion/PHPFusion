...
$locale['414'] = "Vis alle";
$locale['415'] = "Søk etter medlem:";
$locale['416'] = "Søk";
$locale['417'] = "Velg handling";
$locale['418'] = "Avbryt";
$locale['419'] = "Gjeninnsett";
// Ban/Unban/Delete Member
$locale['420'] = "Utestenging gjennomført";
$locale['421'] = "Utestenging opphevet";
$locale['422'] = "Medlem slettet";
$locale['423'] = "Er du sikker på at du ønsker å slette medlemmet?";
...
$locale['451'] = "Du må oppgi brukernavn og e-postadresse.";
...
$locale['458'] = "<strong>Advarsel:</strong> uventet skriptkjøing.";
// View Member Profile
...
$locale['540'] = "Feil";
$locale['541'] = "Feil: Du må oppgi en grunn for suspenderingen!";
$locale['542'] = "Feil: Du må oppgi en grunn for sikkerhetsutestengingen!";
...
$locale['568'] = "Sikkerhets-utestenging gjennomført";
...
$locale['581'] = "Du har flere enn 50 inaktive medlemmer og må kjøre deaktiveringsprosessen <strong>%d ganger</strong>.";
$locale['582'] = "Reaktiver";
$locale['583'] = "Gjenninnsett";
$locale['584'] = "Velg ny status";
$locale['585'] = "Dette medlemmet var opprinnelig utestengt av sikkerhetsgrunner! Er du sikker på at du vil oppheve utestengingen av medlemmet nå?";

$locale['590'] = "Suspender";
$locale['591'] = "Opphev suspendering";
$locale['592'] = "suspenderer";
$locale['593'] = "opphever suspendering";
$locale['594'] = "Vennligst oppgi en grunn for at du gjø dette ";
$locale['595'] = " bruker ";
$locale['596'] = "Varighet:";
...
$locale['604'] = "Grunn:";
// Deactivation System
$locale['610'] = "<strong>%d medlem(er)</strong> har ikke logget inn på <strong>%d dag(er)</strong> og har blitt merket som inaktive. 
Ved å deaktivere disse brukerne vil de ha <strong>%d dag(er)</strong> før de er %s.";
$locale['611'] = "Vær oppmerksom på at noen brukere kan ha bidratt med innhold til siden som foruminnlegg, kommentarer, bilder osv.
Disse vil slettes når deaktiverte brukere slettes.";
$locale['612'] = "bruker";
$locale['613'] = "brukere";
...
$locale['617'] = "Advarsel:";
$locale['618'] = "Det anbefales på det sterkeste å endre handling for deaktivering til anonymiser i stedet for slette for å forhindre tap av data!";
$locale['619'] = "Du kan gjøre det <a href='".ADMIN."settings_users.php".$aidlink."'>her</a>.";

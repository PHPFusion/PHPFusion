...
$locale['global_106'] = "Glemt passordet?<br />Få nytt <a href='".BASEDIR."lostpassword.php' class='side'>ved å klikke her</a>.";
...
$locale['global_132'] = "Du må være innlogget for å stemme.";
...
// Footer Counter
$locale['global_170'] = "Unikt besøk";
$locale['global_171'] = "Unike besøk";
...
[ <a href='index.php'>Eller klikk her om du ikke ønsker å vente</a> ]";
$locale['global_198'] = "<strong>Advarsel:</strong> Filen setup.php er fortsatt på serveren, slett den umidelbart!";
$locale['global_199'] = "<strong>Advarsel:</strong> administratorpassord er ikke oppgitt, klikk <a href='edit_profile.php'>Rediger profil</a> for å oppgi det.";
//Titles
$locale['global_200'] = " - ";
$locale['global_201'] = ": ";
...
$locale['global_406'] = "Kontoen har blitt utestengt av følgende grunn:";
...
$locale['global_441'] = "Din konto på ".$settings['sitename']." har blitt utestengt";
$locale['global_442'] = "Hei [USER_NAME],\n
Din konto på ".$settings['sitename']." ble tatt i å legge til for mange elementer i systemet i løpet av veldig kort tid fra IP-adressen ".USER_IP.", og har derfor blitt utestengt. Dette er gjort for å forhindre bots fra å sende inn søppelmeldinger i rask rekkefølge.\n
Vennligst kontakt sidens administrator på ".$settings['siteemail']." for å få kontoen gjenopprettet eller rapporter hvis det ikke var du som forårsaket utestengelsen.\n
".$settings['siteusername'];
// Lifting of suspension
$locale['global_450'] = "Suspendering automatisk opphevet av systemet";
$locale['global_451'] = "Suspendering opphevet på ".$settings['sitename'];
$locale['global_452'] = "Hei USER_NAME,\n
Suspenderingen av kontoen din på ".$settings['siteurl']." har blitt opphevet. Her er innloggingsdetaljene:\n
...
Suspenderingen av kontoen din på ".$settings['siteurl']." har blitt opphevet.\n\n
Hilsen,\n
".$settings['siteusername'];
$locale['global_454'] = "Konto reaktivert på ".$settings['sitename'];
$locale['global_455'] = "Hei USER_NAME,\n
Sist du logget inn ble kontoen din reaktivert på ".$settings['siteurl']." og kontoen er ikke lengre merket som inaktiv.\n\n
Hilsen,\n
".$settings['siteusername'];

...
$locale['global_058'] = "Прекратить отслеживание";
...
$locale['global_198'] = "<strong>Внимание:</strong> обнаружен скрипт установки, пожалуйста, удалите немедленно папку /INSTALL/.";
...
$locale['flood'] = "Вам запрещено размещать сообщения до окончания времени действия антифлуда. Пожалуйста, подожите до %t";

...
+--------------------------------------------------------+
| Filename: locale/Swedish/user_fields/user_gender.php
...
+--------------------------------------------------------*/
// Gender User Field English Locale by Fangree Productions
$locale['uf_gender'] = "Man eller kvinna";
$locale['uf_gender_000'] = "Ej specificerat";
$locale['uf_gender_001'] = "Man";
$locale['uf_gender_002'] = "Kvinna";
$locale['uf_gender_name'] = "Användarens kön";
$locale['uf_gender_desc'] = "Detta användarfält kommer tillåta användare att ange sitt kön";
$locale['uf_gender_error'] = "Kön kan inte lämnas tomt.";
?>

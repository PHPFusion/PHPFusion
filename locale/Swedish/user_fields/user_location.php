...
+--------------------------------------------------------+
| Filename: locale/Swedish/user_fields/user_location.php
...
+--------------------------------------------------------*/
$locale['uf_location'] = "Hemort";
$locale['uf_location_desc'] = "Land, stad eller ort";
$locale['uf_location_error'] = "Hemort kan inte lämnas tomt.";
?>

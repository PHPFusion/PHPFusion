...
+--------------------------------------------------------+
| Filename: locale/Swedish/user_fields/user_icq.php
...
+--------------------------------------------------------*/
$locale['uf_icq'] = "ICQ#";
$locale['uf_icq_desc'] = "ICQ - nummer";
$locale['uf_icq_error'] = "ICQ kan inte lämnas tomt.";
$locale['uf_icq_error2'] = "ICQ måste vara ett antal siffror.";
?>

...
+--------------------------------------------------------+
| Filename: locale/Swedish/user_fields/user_theme.php
...
$locale['uf_theme_desc'] = "Tillåter användare att välja tema";
$locale['uf_theme_error'] = "Tema kan inte lämnas tomt.";
?>

...
+--------------------------------------------------------+
| Filename: locale/Swedish/user_fields/user_web.php
...
+--------------------------------------------------------*/
$locale['uf_web'] = "Hemsida";
$locale['uf_web_desc'] = "URL för hemsida";
$locale['uf_web_error'] = "Hemsida kan inte lämnas tomt.";
$locale['uf_web_001'] = "Gå till";
?>

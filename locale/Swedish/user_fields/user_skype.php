...
+--------------------------------------------------------+
| Filename: locale/Swedish/user_fields/user_skype.php
...
$locale['uf_skype_desc'] = "Skype text, röst-och videochatt.";
$locale['uf_skype_error'] = "Skype namn kan inte lämnas tomt.";
?>

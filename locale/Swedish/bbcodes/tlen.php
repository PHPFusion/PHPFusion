...
+--------------------------------------------------------+
| Filename: locale/Swedish/bbcode/tlen.php
...
+--------------------------------------------------------*/
$locale['bb_tlen_description'] = "Visning av användarstatus för 'Tlen Polish communicator'";
$locale['bb_tlen_usage'] = "Tlen användar - ID";
?>

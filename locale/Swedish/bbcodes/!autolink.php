...
+--------------------------------------------------------+
| Filename: locale/Swedish/bbcodes/!autolink.php
...
+--------------------------------------------------------*/
$locale['bb_autolink_description'] = "Gör länkar och e-post adresser klickbara.";
$locale['bb_autolink_usage'] = "Den här bb koden har ingen knapp. MÅSTE stå ovanför URL och Mail bbkod.";
?>
...
+--------------------------------------------------------+
| Filename: locale/Swedish/bbcodes/color.php
...
+--------------------------------------------------------*/
$locale['bb_color_description'] = "Sätt färg på markerad text";
$locale['bb_color_usage'] = "Sätt färg på markerad text";
$locale['bb_color_hex'] = "HEX färgvärde med hash";
?>

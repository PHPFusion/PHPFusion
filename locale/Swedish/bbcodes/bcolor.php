...
+--------------------------------------------------------+
| Filename: locale/Swedish/bbcodes/bcolor.php
...
+--------------------------------------------------------*/
$locale['bb_bcolor_description'] = "Bakgrundsfärg för markerad text";
$locale['bb_bcolor_usage'] = "Bakgrundsfärg för markerad text";
$locale['bb_bcolor_hex'] = "HEX bakgrundsfärgsvärde";
?>

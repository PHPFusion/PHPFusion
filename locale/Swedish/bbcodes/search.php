...
+--------------------------------------------------------+
| Filename: locale/Swedish/bbcodes/search.php
...
+--------------------------------------------------------*/
$locale['bb_search_description'] = "Sök efter angiven text på nuvarande sida";
$locale['bb_search_usage'] = "Text att söka";
$locale['bb_search_prefix'] = "Sök efter ";
$locale['bb_search_suffix'] = " i ";
$locale['bb_search_where'] = "Där";
?>

...
+--------------------------------------------------------+
| Filename: locale/Swedish/bbcodes/php.php
...
+--------------------------------------------------------*/
$locale['bb_php'] = "PHP";
$locale['bb_php_description'] = "Gör PHP - kod av markerad text";
$locale['bb_php_usage'] = "PHP - kod som ska markeras";
$locale['bb_php_save'] = "Nedladdningskälla";
?>
...
+--------------------------------------------------------+
| Filename: locale/Swedish/bbcodes/flash.php
...
+--------------------------------------------------------*/
$locale['bb_flash_description'] = "Visar en flashanimering från angiven URL";
$locale['bb_flash_usage'] = "Flashanimerad URL";
$locale['bb_flash_width'] = "Bredd i px";
$locale['bb_flash_height'] = "Höjd i px";
?>

...
$pattern = array(
	...
	"articles/%article_id%/%article_title%#comments" => "infusions/articles/articles.php?article_id=%article_id%#comments",
	"articles/%article_id%-%rowstart%/%article_title%#comments" => "infusions/articles/articles.php?article_id=%article_id%&amp;rowstart=%rowstart%#comments",

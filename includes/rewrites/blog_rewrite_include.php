...
$pattern = array(
    ...
    "blogs/comments-reply-%comment_cat%/%blog_id%/%blog_title%#%comment_id%" => "infusions/blog/blog.php?readmore=%blog_id%&amp;comment_reply=%comment_cat%%hash_stop%#c%comment_id%",

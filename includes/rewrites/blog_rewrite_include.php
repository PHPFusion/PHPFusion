...
$pattern = array(
    "blogs/comments-reply-%comment_cat%/%blog_id%/%blog_title%"               => "infusions/blog/blog.php?readmore=%blog_id%&amp;comment_reply=%comment_cat%",
    "blogs/comments-reply-%comment_cat%/%blog_id%/%blog_title%#c%comment_id%" => "infusions/blog/blog.php?readmore=%blog_id%&amp;comment_reply=%comment_cat%#c%comment_id%",

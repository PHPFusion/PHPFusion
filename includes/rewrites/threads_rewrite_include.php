...
$regex = array("%thread_title%" => "([a-zA-Z0-9-]+)", "%thread_id%" => "([0-9]+)", "%post_id%" => "([0-9]+)",
			   "%thread_rowstart%" => "([0-9]+)");
$pattern = array("forum/thread/%thread_id%/rowstart/%thread_rowstart%/%thread_title%" => "forum/viewthread.php?thread_id=%thread_id%&amp;rowstart=%thread_rowstart%",

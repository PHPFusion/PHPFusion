...
if (isset($input_id) && ($input_id !=="")) { $input_id = stripinput($input_id); } else { $input_id = ""; }
if (isset($input_value) && ($input_value !=="")) { $input_value = stripinput($input_value);
} else { $input_value = "";  }
...
if ($stacking == "1") {
$col = "col-sm-12 col-md-12 col-lg-12"; $col2 = "col-sm-12 col-md-12 col-lg-12";
} else {
$col = "col-sm-12 col-md-3 col-lg-3 control-label"; $col2 = "col-sm-12 col-md-9 col-lg-9";
}

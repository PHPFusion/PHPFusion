...
function form_textarea($input_name, $label = '', $input_value = '', array $options = []) {
    ...
    if ($options['type'] == "tinymce") {
        ...
        $default_tinymce_css = !empty(THEMES."themes/admin_themes/".fusion_get_settings('admin_theme')."/tinymce.css") ? THEMES."themes/admin_themes/".fusion_get_settings('admin_theme')."/tinymce.css" : THEMES."templates/tinymce.css";

...
function form_textarea($input_name, $label = '', $input_value = '', array $options = []) {
    ...
    $html .= ($label) ? "<label class='control-label ".($options['inline'] ? "col-xs-12 col-sm-3 col-md-3 col-lg-3" : '')."' for='".$options['input_id']."'>".$label.($options['required'] == 1 ? "<span class='required'>&nbsp;*</span>" : '')." ".($options['tip'] ? "<br/><small>".$options['tip']."</small>" : '')."</label>\n" : '';

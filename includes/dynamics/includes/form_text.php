...
function form_text($title = FALSE, $input_name, $input_id, $input_value = FALSE, array $options = array()) {
	...
	$html .= "<div id='$input_id-field' class='form-group ".$options['class']." ".($options['icon'] ? 'has-feedback' : '')."'  ".($options['inline'] && $options['width'] && !$title ? "style='width: ".$options['width']." !important;'" : '').">\n";
	...
	$html .= ($options['prepend_button']) ? "<span class='input-group-btn'>\n<button id='".$input_id."-prepend-btn' name='p-submit-".$input_id."' type='".$options['prepend_type']."' value='".$options['prepend_form_value']."' class='btn ".$options['prepend_size']." ".$options['prepend_class']."'>".$options['prepend_value']."</button></span>" : '';
	...
	$html .= ($options['append_button']) ? "<span class='input-group-btn'><button id='".$input_id."-append-btn' name='p-submit-".$input_id."' type='".$options['append_type']."' value='".$options['append_form_value']."' class='btn ".$options['append_size']." ".$options['append_class']."'>".$options['append_value']."</button></span>" : '';

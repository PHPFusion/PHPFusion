...
function form_text($title = FALSE, $input_name, $input_id, $input_value = FALSE, array $options = array()) {
	...
	$html .= ($options['prepend_button']) ? "<span class='input-group-btn'>\n<button id='".$input_id."-prepend-btn' type='".$options['prepend_type']."' value='submit-".$input_name."' class='btn ".$options['prepend_size']." ".$options['prepend_class']."'>".$options['prepend_value']."</button></span>" : '';
	...
	$html .= ($options['append_button']) ? "<span class='input-group-btn'><button id='".$input_id."-append-btn' type='".$options['append_type']."' value='submit-".$input_name."' class='btn ".$options['append_size']." ".$options['append_class']."'>".$options['append_value']."</button></span>" : '';

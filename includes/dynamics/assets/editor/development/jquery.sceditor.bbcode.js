...
// TODO: Make configurable
	...
	/** @lends jQuery.sceditor.dom */
	{
		 ...
		 * @type {string}
		 */
		blockLevelList: '|body|hr|p|div|h1|h2|h3|h4|h5|h6|address|pre|includes|table|tbody|thead|tfoot|th|tr|td|li|ol|ul|blockquote|center|',
	...
	$.sceditor.defaultOptions = {
		...
		emoticons: {
			dropdown: {
                ':)' : 'emoticons/smile.png',
                ':2)' : 'emoticons/happy.png',
                ':3)' : 'emoticons/superhappy.png',
                'O)' : 'emoticons/excite.png',
                ':(' : 'emoticons/sad.png',
                ':2(' : 'emoticons/sad_2.png',
                ':3(' : 'emoticons/sad_3.png',
                ':D' : 'emoticons/laugh.png',
                '(rofl)': 'emoticons/lol.png',
                ':^)': 'emoticons/wondering.png',
                ':^2)': 'emoticons/wondering_2.png',
                ':P': 'emoticons/cheeky.png',
                '(wink)' : 'emoticons/wink.png',
                ':8' : 'emoticons/cool.png',
                ':28' : 'emoticons/cool_2.png',
                ';(' : 'emoticons/cry.png',
                'T_T' : 'emoticons/cry_2.png',
                'TT_TT' : 'emoticons/cry_3.png',
                '^^;' : 'emoticons/sweat.png',
                ':|' : 'emoticons/speechless.png',
                ':O': 'emoticons/waaaht.png',
                ':*': 'emoticons/kiss.png',
                '*:': 'emoticons/kissed.png',
                ':x': 'emoticons/seal.png',
                ':#': 'emoticons/superseal.png',
                'x|': 'emoticons/dead.png',
                '(hot)': 'emoticons/hot.png',
                '(yn)': 'emoticons/yn.png',
                ':$': 'emoticons/blush.png',
                '(grr)': 'emoticons/anger.png',
                '(bad)': 'emoticons/bad.png',
                'B|': 'emoticons/nerd.png',
                '(mm)': 'emoticons/mm.png',
                '(meow)': 'emoticons/meow.png',
                '(wasntme)': 'emoticons/wasntme.png',
                '(party)': 'emoticons/party.png',
                '(shame)': 'emoticons/shame.png',
                'oO)': 'emoticons/shocked.png',
                '(np)': 'emoticons/np.png',
                '(devil)': 'emoticons/devil.png',
                '(drool)': 'emoticons/drool.png',
                '(give)': 'emoticons/give.png',
                '(givereject)': 'emoticons/givereject.png',
                '(adore)': 'emoticons/adore.png',

            },
			more: {
                ':@': 'emoticons/angry.png',
                ':2@': 'emoticons/angry_2.png',
                ':3@': 'emoticons/superangry.png',
                '>.>': 'emoticons/doubt.png',
                '(punk)': 'emoticons/punk.png',
                '(boom)': 'emoticons/after_boom.png',
                '(alien)': 'emoticons/alien.png',
                '(aqua)': 'emoticons/aqua.png',
                '(baby)': 'emoticons/baby.png',
                '-.-': 'emoticons/dull.png',
                '(love)': 'emoticons/love.png',
                '(snooze)': 'emoticons/snooze.png',
                ']:)': 'emoticons/grin.png',
                '>:)': 'emoticons/grin_2.png',
                '(yawn)': 'emoticons/yawn.png',
                '(puke)': 'emoticons/puke.png',
                '(doh)': 'emoticons/doh.png',
                '(smirk)': 'emoticons/smirk.png',
                '(phew)': 'emoticons/phew.png',
                '(scold)': 'emoticons/scold.png',
                '(grump)': 'emoticons/grump.png',
                '(sorry)': 'emoticons/sorry.png',
                '(bb)': 'emoticons/bye.png',
                '(mark)': 'emoticons/mark.png',
                '(surrender)': 'emoticons/surrender.png',
                '(greed)': 'emoticons/greed.png',
                '(.)': 'emoticons/confuse.png',
                '(..)': 'emoticons/baffle.png',
                '(...)': 'emoticons/stupid.png',
                '(....)': 'emoticons/crazy.png',
                '(.....)': 'emoticons/kaput.png',
                '(ninja)': 'emoticons/ninja.png',
                '(ninjaking)': 'emoticons/ninjaking.png',
                '(codeninja)': 'emoticons/codeninja.png',
                '(codeninjaking)': 'emoticons/codeninjaking.png',
                '(music)': 'emoticons/music.png',
                '(spider)': 'emoticons/spider.png',
                '(blind)': 'emoticons/blind.png',
                '(drunk)': 'emoticons/drunk.png',
                '($$$)': 'emoticons/rich.png',
                '(what)': 'emoticons/what.png',
                '(eye)': 'emoticons/eye.png',
                '(troll)': 'emoticons/troll.png',
                '(trollking)': 'emoticons/trollking.png',
                '(pirate)': 'emoticons/pirate.png',
                '(bomb)': 'emoticons/bomb.png',
                '(monkey)': 'emoticons/monkey.png',
                '(panda)': 'emoticons/panda.png',
                '(vampire)': 'emoticons/vamp.png',
                '(clown)': 'emoticons/clown.png',
                '(mischief)': 'emoticons/mischief.png',
                '(pray)': 'emoticons/pray.png',
                '(attitude)': 'emoticons/sure.png',
                '(batman)': 'emoticons/batman.png',
                '(chick)': 'emoticons/chick.png',
                '(nose)': 'emoticons/nose.png',
                '(bandit)': 'emoticons/bandit.png',
                '(banditking)': 'emoticons/banditking.png',
                '(mummy)': 'emoticons/mummy.png',
            },
			hidden: {
                ':-)' : 'emoticons/smile.png',
                ':=)' : 'emoticons/smile.png',
                ...
                '(lol)': 'emoticons/ah.png',
                ':-28' : 'emoticons/cool_2.png',
                ':=28' : 'emoticons/cool_2.png',
                '(cool2)' : 'emoticons/cool_2.png',
                ':o:' : 'emoticons/wink.png',
                ':O:' : 'emoticons/wink.png',
                '=(' : 'emoticons/cry.png',
                'T.T' : 'emoticons/cry_2.png',
                'TT.TT' : 'emoticons/cry_3.png',
                '>_>': 'emoticons/doubt.png',

                '^.^;' : 'emoticons/sweat.png',
                '^_^;' : 'emoticons/sweat.png',
                ':=|' : 'emoticons/speechless.png',
                ':-O': 'emoticons/waaaht.png',
                ':=O': 'emoticons/waaaht.png',
                ':=*': 'emoticons/kiss.png',
                ...
                ':-$': 'emoticons/blush.png',
                ':=$': 'emoticons/blush.png',
                '|=)': 'emoticons/snooze.png',
                '|-)': 'emoticons/snooze.png',
                '-_-': 'emoticons/dull.png',
                '|(': 'emoticons/dull.png',
                '<3': 'emoticons/love.png',
                '(angry)': 'emoticons/angry.png',
                ':=@': 'emoticons/angry.png',
                ':-@': 'emoticons/angry.png',
                '(angry2)': 'emoticons/angry_2.png',
                ':=@@': 'emoticons/angry_2.png',
                ':-@@': 'emoticons/angry_2.png',
                '(angry3)': 'emoticons/angry_2.png',
                ':-@@@': 'emoticons/superangry.png',
                ':=@@@': 'emoticons/superangry.png',
                '(nerd)': 'emoticons/nerd.png',
                '8|': 'emoticons/nerd.png',
                'B-|': 'emoticons/nerd.png',
                '8=|': 'emoticons/nerd.png',
                ':-x': 'emoticons/seal.png',
                ':=x': 'emoticons/seal.png',
                ':-#': 'emoticons/superseal.png',
                ':=#': 'emoticons/superseal.png',
                'x_x': 'emoticons/dead.png',
                'X_X': 'emoticons/dead.png',
                'X.X': 'emoticons/dead.png',
                ':blush:': 'emoticons/shame.png',
                'o.O': 'emoticons/shocked.png',
                'O.O': 'emoticons/shocked.png',
                'O_O': 'emoticons/shocked.png',
                'o_O': 'emoticons/shocked.png',

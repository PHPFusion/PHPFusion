...
$thumbs_base_path = '../../images/thumb/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$fixed_image_creation_name_to_prepend   = array('','edit_'); //name to prepend on filename
$fixed_image_creation_to_append         = array('_edit',''); //name to appendon filename
...
$relative_image_creation_name_to_prepend= array('','fusion_'); //name to prepend on filename
$relative_image_creation_name_to_append = array('_fusion',''); //name to append on filename

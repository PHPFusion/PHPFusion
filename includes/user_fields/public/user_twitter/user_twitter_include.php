...
$icon = "<img src='".INCLUDES."user_fields/public/user_twitter/images/twitter.svg' title='".$locale['uf_twitter']."' alt='".$locale['uf_twitter']."'/>";
...
if ( $profile_method == "input" ) {
    ...
    if ( $field_value ) {
        ...
        $field_value = ( $index_userweb ? '' : "<!--noindex-->" )."<a href='".$link."' title='".$field_value."' ".( $index_userweb ? '' : "rel='nofollow noopener noreferrer' " )."target='_blank'>".$locale['uf_twitter_desc']."</a>".( $index_userweb ? '' : "<!--/noindex-->" );
    }
    $user_fields = [
        'icon'  => $icon,
        'link'  => $link,

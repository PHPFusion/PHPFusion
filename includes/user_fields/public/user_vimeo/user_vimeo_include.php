...
$icon = "<img src='".INCLUDES."user_fields/public/user_vimeo/images/vimeo.svg' title='".$locale['uf_vimeo']."' alt='".$locale['uf_vimeo']."'/>";
...
if ( $profile_method == "input" ) {
    ...
    if ( $field_value ) {
        ...
        $field_value = ( $index_userweb ? '' : "<!--noindex-->" )."<a href='".$link."' title='".$field_value."' ".( $index_userweb ? '' : "rel='nofollow noopener noreferrer' " )."target='_blank'>".$locale['uf_vimeo_desc']."</a>".( $index_userweb ? '' : "<!--/noindex-->" );
    }
    $user_fields = [
        'icon'  => $icon,
        'link'  => $link,

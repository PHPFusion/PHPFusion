...
if ($profile_method == "input") {
    ...
    if (defined('ADMIN_PANEL')) { // To show in admin panel only.
        $user_fields = "<div class='list-group-item strong spacer-sm text-center'>AddonDB Dashboard Interface</div>";
    }
    ...
    require_once ADDON."autoloader.php";
    $html = new \PHPFusion\Addondb\AddondbDashboard();
    // set the subnavs.
    $html->userData = $user;

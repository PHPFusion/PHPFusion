...
if ($profile_method == "input") {
	...
	echo "<input type='text' id='user_web' name='user_web' value='".$user_web."' maxlength='50' class='textbox form-control' style='width:200px;' />";
	echo "</td>\n</tr>\n";
	if ($required) {
		$this->setRequiredJavaScript("user_web", $locale['uf_web_error']);
	}
	// Display in profile

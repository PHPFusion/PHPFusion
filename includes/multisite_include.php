...
define("DB_PERMALINK_REWRITE", DB_PREFIX."permalinks_rewrites"); // rewrite
define("DB_PERMALINK_METHOD", DB_PREFIX."permalinks_method"); // patten
define("DB_PERMALINK_ALIAS", DB_PREFIX."permalinks_alias"); // alias open notepad :P

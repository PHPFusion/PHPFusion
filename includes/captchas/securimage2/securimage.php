...
class Securimage {
    ...
    function Securimage() {
        ...
        $this->multi_text_color = array(
            new Securimage_Color(0x0, 0x20, 0xCC), new Securimage_Color(0x0, 0x30, 0xEE),
    ...
    function drawWord() {
        ...
        if ($this->use_gd_font == TRUE || !is_readable($this->ttf_file)) {
            ...
            imagestring($this->im, $font, $this->text_x_start, ($this->image_height / 2) - ($this->gd_font_size / 2), $this->code,
                        $this->gdtextcolor);
        } else { //ttf font
    ...
    function addSignature() {
        if ($this->use_gd_font) {
            imagestring($this->im, 5, $this->image_width - (strlen($this->image_signature) * 10), $this->image_height - 20, $this->image_signature,
                        $this->gdsignaturecolor);
        } else {
        ...
        if ($this->use_sqlite_db && function_exists('sqlite_open')) {
            ...
            if ($this->sqlite_handle !== FALSE) {
                ...
                if (sqlite_num_rows($res) == 0) {
                    sqlite_query($this->sqlite_handle,

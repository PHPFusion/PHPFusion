...
class Securimage {
    ...
    function __construct() {
        ...
        if (session_id() == COOKIE_PREFIX.'session') {
            if (trim($this->session_name) != COOKIE_PREFIX.'session') {
        ...
        $this->gd_font_file  = $this->basepath.'gd_fonts/automatic.gdf';
        $this->use_gd_font   = TRUE;
        $this->gd_font_size  = 24;
        $this->text_x_start  = 15;
        $this->ttf_file      = $this->basepath.'ttf_fonts/AHGBold.ttf';
        ...
        $this->signature_font  = $this->basepath.'ttf_fonts/AHGBold.ttf';
        ...
        $this->sqlite_database = $this->basepath.'database/securimage.sqlite';

<?php
$default_mobile_icon = array('index.php' => 'entypo home', 'articles.php' => 'entypo docs',
							 'article_cats.php' => 'entypo docs', 'downloads.php' => 'entypo box',
							 'faq.php' => 'entypo info', 'forum/index.php' => 'entypo icomment',
							 'news.php' => 'entypo newspaper', 'news_cats.php' => 'entypo newspaper',
							 'weblinks.php' => 'entypo link', 'contact.php' => 'entypo envelope',
							 'photogallery.php' => 'entypo image', 'search.php' => 'entypo search',

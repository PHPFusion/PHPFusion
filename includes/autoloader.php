...
/**
 * Administration links autoloading
 */
spl_autoload_register(function ($className) {
...
spl_autoload_register(function ($className) {
    if (stristr($className, 'PHPFusion\\Infusions')) {
        ...
        $full_path = BASEDIR . 'infusions/' . $className . '.class.php';
...
if (file_exists(__DIR__ . "/custom_includes.php")) {

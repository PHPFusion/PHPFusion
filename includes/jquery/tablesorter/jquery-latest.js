...
(function (A, w) {
    ...
    c.extend({get: function (a, b, d, f) {
        ...
        global: true, type: "GET", contentType: "application/x-www-includes-urlencoded", processData: true, async: true, xhr: A.XMLHttpRequest && (A.location.protocol !== "file:" || !A.ActiveXObject) ? function () {

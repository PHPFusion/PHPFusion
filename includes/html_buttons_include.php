...
function display_html($formname, $textarea, $html = TRUE, $colors = FALSE, $images = FALSE, $folder = "") {
    ...
    if ($html) {
        ...
        $res .= "<button title='".$locale['html_019']."' class='dropdown-toggle btn btn-sm btn-default m-b-10 button' data-toggle='dropdown'><i class='fa fa-heading'></i><span class='caret'></span></button>\n";
        $res .= "<ul class='dropdown-menu' style='width:190px;'>\n";

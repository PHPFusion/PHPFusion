/* http://prismjs.com/download.html?themes=prism-coy&languages=markup+css+clike+javascript+php+php-extras+sql */
                ...
                for (var s = 0; s < o.length; ++s) {
                    ...
                    for (var m = 0, y = 0; m < r.length; y += (r[m].matchedStr || r[m]).length, ++m) {
                        ...
                        if (!(v instanceof a)) {
                            ...
                            if (b) {
                                g && (f = b[1].length);
                                var w = b.index + f, b = b[0].slice(f), _ = w + b.length, x = v.slice(0, w), O = v.slice(_), j = [m, k];
                                x && j.push(x);

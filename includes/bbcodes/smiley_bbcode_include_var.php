...
$__BBCODE__[] = [
    "description"    => $locale['bb_smiley_description'], "value" => "smiley", "bbcode_start" => "",
    ...
    "html_start"     => "<div id='bbcode_smileys_list_".$textarea_name."' class='tbl1 bbcode-popup' style='display:none;border:1px solid black;position:absolute;overflow:auto;max-width:300px;height:auto;' onclick=\"overlayclose('bbcode_smileys_list_".$textarea_name."');\">",

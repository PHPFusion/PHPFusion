!function (e) {
        ...
        e.each(["text", "html", "val"], function (t, a) {
            ...
            e.fn[a] = function (t) {
                ...
                return (s ? a : a.eq(0)).each(function (t, n) {
                    var i = r(n);
                    o += i ? s ? i.getContent().replace(/<(?:"[^"]*"|'[^']*'|[^'">])*>/g, "") : i.getContent({save: !0}) : u.apply(e(n), l)
                }), o
            }
        }), e.each(["append", "prepend"], function (t, i) {
            var a = o[i] = e.fn[i], u = "prepend" === i;
            e.fn[i] = function (e) {
                var t = this;
            ...
            var l = u[0], m = r(l);
            return m ? m.getContent({save: !0}) : o.attr.apply(e(l), s)
        }
    }
    ...
    e.fn.tinymce = function (n) {
        ...
        var o, u, s, l, m = this, p = "";
        if (!m.length)return m;
        if (!n)return window.tinymce ? tinymce.get(m[0].id) : null;
        if (m.css("visibility", "hidden"), a.tinymce || i || !(o = n.script_url))1 === i ? r.push(c) : c(); else {

...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        function i() {
            ...
            c = o + (+new Date).toString(32), d = "onmouseenter"in document.documentElement, u = "onfocusin"in document.documentElement, f = {
                ...
                if (t && 3 !== t.nodeType && 8 !== t.nodeType) {
                    ...
                    }), v = s[g][b], v ? "ready" === b && a.domLoaded ? p({type: b}) : v.push({func: p, scope: h}) : (s[g][b] = v = [{
                        func: p,
                        scope: h
        ...
        function r(e) {
            var t = e, n, r;
            if (!g(e))for (t = [], n = 0, r = e.length; r > n; n++)t[n] = e[n];
            return t
        }
        ...
        function l(e, t, n, r) {
            var i;
            if (a(t))t = s(t, g(e[0])); else if (t.length && !t.nodeType) {
                if (t = d.makeArray(t), r)for (i = t.length - 1; i >= 0; i--)l(e, t[i], n, r); else for (i = 0; i < t.length; i++)l(e, t[i], n, r);
                return e
            }
        ...
        function y(e, n, r, i) {
            var o = [];
            for (i instanceof d && (i = i[0]); e; e = e[n])if (!r || e.nodeType === r) {
                if (i !== t) {
                    if (e === i)break;
        ...
        var x = document, w = Array.prototype.push, _ = Array.prototype.slice, E = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, k = e.Event, N, S = r.makeMap("fillOpacity fontWeight lineHeight opacity orphans widows zIndex zoom", " "), T = r.makeMap("checked compact declare defer disabled ismap multiple nohref noshade nowrap readonly selected", " "), R = {
            "for": "htmlFor",
            "class": "className",
            readonly: "readOnly"
        }, A = {"float": "cssFloat"}, B = {}, D = {}, H = /^\s*|\s*$/g;
        return d.fn = d.prototype = {
            constructor: d, selector: "", context: null, length: 0, init: function (e, t) {
                var n = this, r, i;
                if (!e)return n;
                ...
                if (a(e)) {
                    ...
                    if (r[1])for (i = s(e, g(t)).firstChild; i;)w.call(n, i), i = i.nextSibling; else {
                ...
                if (t !== !1)for (r = d.unique(n.toArray().concat(d.makeArray(e))), n.length = r.length, i = 0; i < r.length; i++)n[i] = r[i]; else w.apply(n, d.makeArray(e));
                return n
            }, attr: function (e, t) {
                var n = this, r;
                if ("object" == typeof e)h(e, function (e, t) {
                    ...
                    if (!o(t)) {
                        if (n[0] && 1 === n[0].nodeType) {
                            ...
                            if (T[e])return n.prop(e) ? e : N;
                            t = n[0].getAttribute(e, 2), null === t && (t = N)
                        }
                        return t
                    }
                    this.each(function () {
        ...
        function t(n) {
            ...
            var M = this, L = n.doc, P = 0, O = 1, I = 2, F = !0, z = !1, W = "startOffset", V = "startContainer", U = "endContainer", $ = "endOffset", q = e.extend, j = n.nodeIndex;
            return q(M, {
                startContainer: L,
                startOffset: 0,
                endContainer: L,
        ...
        return function (e) {
            ...
            function f(e) {
                var n, r, i, o, s, l, c, f, p, h, m, g, v, b, x, w, _, E, k, N = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)\])?$/, S = /^([!\-])?(\w+::\w+|[^=:<]+)?(?:([=:<])(.*))?$/, T = /[*?+]/;
                if (e)for (e = t(e, ","), y["@"] && (w = y["@"].attributes, _ = y["@"].attributesOrder), n = 0, r = e.length; r > n; n++)if (s = N.exec(e[n])) {
                    ...
                    if (f)for (f = t(f, "|"), i = 0, o = f.length; o > i; i++)if (s = S.exec(f[i])) {
                        if (c = {}, m = s[1], h = s[2].replace(/::/g, ":"), b = s[3], k = s[4], "!" === m && (l.attributesRequired = l.attributesRequired || [], l.attributesRequired.push(h), c.required = !0), "-" === m) {
                        ...
                        b && ("=" === b && (l.attributesDefault = l.attributesDefault || [], l.attributesDefault.push({
                            name: h,
                            value: k
                        }), c.defaultValue = k), ":" === b && (l.attributesForced = l.attributesForced || [], l.attributesForced.push({
                            name: h,
                            value: k
                        }), c.forcedValue = k), "<" === b && (c.validValues = a(k, "?"))), T.test(h) ? (l.attributePatterns = l.attributePatterns || [], c.pattern = d(h), l.attributePatterns.push(c)) : (g[h] || v.push(h), g[h] = c)
                    }
            ...
            var v = this, y = {}, b = {}, C = [], x, w, _, E, k, N, S, T, R, A, B, D, H = {}, M = {};
        ...
        function i(i, a) {
            ...
            i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var l = this, c, u = 0, d, f, p = [], h, m, g, v, y, b, C, x, w, _, E, k, N, S, T, R, A, B, D, H, M, L, P, O, I, F = 0, z = t.decode, W, V = n.makeMap("src,href,data,background,formaction,poster"), U = /((java|vb)script|mhtml):/i, $ = /^data:/i;
                for (L = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-_\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), P = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, C = a.getShortEndedElements(), M = i.self_closing_elements || a.getSelfClosingElements(), x = a.getBoolAttrs(), _ = i.validate, b = i.remove_internals, W = i.fix_self_closing, O = a.getSpecialElements(); c = L.exec(e);) {
                    if (u < c.index && l.text(z(e.substr(u, c.index - u))), d = c[6])d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), o(d); else if (d = c[7]) {
                        if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), w = d in C, W && M[d] && p.length > 0 && p[p.length - 1].name === d && o(d), !_ || (E = a.getElementRule(d))) {
                            if (k = !0, _ && (T = E.attributes, R = E.attributePatterns), (S = c[8]) ? (y = -1 !== S.indexOf("data-mce-type"), y && b && (k = !1), h = [], h.map = {}, S.replace(P, s)) : (h = [], h.map = {}), _ && !y) {
                                if (A = E.attributesRequired, B = E.attributesDefault, D = E.attributesForced, H = E.removeEmptyAttrs, H && !h.length && (k = !1), D)for (m = D.length; m--;)N = D[m], v = N.name, I = N.value, "{$uid}" === I && (I = "mce_" + F++), h.map[v] = I, h.push({
                                    name: v,
                                    value: I
                                });
                                if (B)for (m = B.length; m--;)N = B[m], v = N.name, v in h.map || (I = N.value, "{$uid}" === I && (I = "mce_" + F++), h.map[v] = I, h.push({
                                    name: v,
                                    value: I
                                }));
                                if (A) {
                        ...
                        if (f = O[d]) {
                            f.lastIndex = u = c.index + c[0].length, (c = f.exec(e)) ? (k && (g = e.substr(u, c.index - u)), u = c.index + c[0].length) : (g = e.substr(u), u = e.length), k && (g.length > 0 && l.text(g, !0), l.end(d)), L.lastIndex = u;
                            continue
                        }
                        w || (S && S.indexOf("/") == S.length - 1 ? k && l.end(d) : p.push({name: d, valid: k}))
        ...
        return function (r, l) {
            ...
            r = r || {}, r.validate = "validate"in r ? r.validate : !0, r.root_name = r.root_name || "body", u.schema = l = l || new t, u.filterNode = function (e) {
                ...
                var v, y, b, C, x, w, _, E, k, N, S, T, R, A = [], B, D, H, M, L, P, O, I;
                if (o = o || {}, p = {}, h = {}, T = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), P = l.children, S = r.validate, I = "forced_root_block"in o ? o.forced_root_block : r.forced_root_block, L = l.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, D = /[ \t\r\n]+$/, H = /[ \t\r\n]+/g, M = /^[ \t\r\n]+$/, v = new n({
                        ...
                        start: function (e, t, n) {
                            ...
                            if (o = S ? l.getElementRule(e) : {}) {
                                for (r = u(o.outputName || e, 1), r.attributes = t, r.shortEnded = n, b.append(r), s = P[b.name], s && P[r.name] && !s[r.name] && A.push(r), i = f.length; i--;)a = f[i].name, a in t.map && (k = h[a], k ? k.push(r) : h[a] = [r]);
                    ...
                    for (N in p) {
                        for (k = d[N], C = p[N], _ = C.length; _--;)C[_].parent || C.splice(_, 1);
                        for (x = 0, w = k.length; w > x; x++)k[x](C, N, o)
                    }
                    for (x = 0, w = f.length; w > x; x++)if (k = f[x], k.name in h) {
                        for (C = h[k.name], _ = C.length; _--;)C[_].parent || C.splice(_, 1);
                        for (_ = 0, E = k.callbacks.length; E > _; _++)k.callbacks[_](C, k.name, o)
                    }
                }
                return y
    ...
    }), r(R, [y, N, g, T, _, E, d, u], function (e, t, n, r, i, o, a, s) {
        ...
        return {
            BACKSPACE: 8, DELETE: 46, DOWN: 40, ENTER: 13, LEFT: 37, RIGHT: 39, SPACEBAR: 32, TAB: 9, UP: 38, modifierPressed: function (e) {
        ...
        return function (r, i) {
            ...
            function a(t) {
                var n, r, o, a, s;
                n = t.screenX - T, r = t.screenY - R, P = n * N[2] + D, O = r * N[3] + H, P = 5 > P ? 5 : P, O = 5 > O ? 5 : O, o = "IMG" == w.nodeName && i.settings.resize_img_proportional !== !1 ? !e.modifierPressed(t) : e.modifierPressed(t) || "IMG" == w.nodeName && N[2] * N[3] !== 0, o && (W(n) > W(r) ? (O = V(P * M), P = V(O / M)) : (P = V(O / M), O = V(P * M))), C.setStyles(_, {
                    width: P,
                    height: O
                }), a = N.startPos.x + n, s = N.startPos.y + r, a = a > 0 ? a : 0, s = s > 0 ? s : 0, C.setStyles(E, {
                    left: a,
                    top: s,
                    display: "block"
                }), E.innerHTML = P + " &times; " + O, N[2] < 0 && _.clientWidth <= P && C.setStyle(_, "left", A + (D - P)), N[3] < 0 && _.clientHeight <= O && C.setStyle(_, "top", B + (H - O)), n = U.scrollWidth - $, r = U.scrollHeight - q, n + r !== 0 && C.setStyles(E, {
                    left: a - n,
                    top: s - r
                }), L || (i.fire("ObjectResizeStart", {target: w, width: D, height: H}), L = !0)
            }
            ...
            function s() {
                ...
                L = !1, e("width", P), e("height", O), C.unbind(I, "mousemove", a), C.unbind(I, "mouseup", s), F != I && (C.unbind(F, "mousemove", a), C.unbind(F, "mouseup", s)), C.remove(_), C.remove(E), z && "TABLE" != w.nodeName || l(w), i.fire("ObjectResized", {
                    target: w,
                    width: P,
                    height: O
            ...
            function l(e, t, r) {
                var l, u, d, f, p;
                g(), l = C.getPos(e, U), A = l.x, B = l.y, p = e.getBoundingClientRect(), u = p.width || p.right - p.left, d = p.height || p.bottom - p.top, w != e && (m(), w = e, P = O = 0), f = i.fire("ObjectSelected", {target: e}), o(e) && !f.isDefaultPrevented() ? x(k, function (e, i) {
                    function o(t) {
                        T = t.screenX, R = t.screenY, D = w.clientWidth, H = w.clientHeight, M = H / D, N = e, e.startPos = {
                            x: u * e[0] + A,
                            y: d * e[1] + B
            ...
            function c() {
                ...
                for (e in k)t = C.get("mceResizeHandle" + e), t && (C.unbind(t), C.remove(t))
            }
            ...
            function u(e) {
                ...
                var n, i;
                if (!L)return x(C.select("img[data-mce-selected],hr[data-mce-selected]"), function (e) {
            ...
            function p(e) {
                ...
                for (r in k)if (o = k[r], a = t.offsetWidth * o[0], s = t.offsetHeight * o[1], W(a - c) < 8 && W(s - u) < 8) {
                    N = o;
                    break
                }
            ...
            var C = i.dom, x = t.each, w, _, E, k, N, S, T, R, A, B, D, H, M, L, P, O, I = i.getDoc(), F = document, z = n.ie && n.ie < 11, W = Math.abs, V = Math.round, U = i.getBody(), $, q;
            k = {
                n: [.5, 0, 0, -1],
                e: [1, .5, 1, 0],
                s: [.5, 1, 0, 1],
            ...
            return i.contentStyles.push(j + " div.mce-resizehandle {position: absolute;border: 1px solid black;background: #FFF;width: 5px;height: 5px;z-index: 10000}" + j + " .mce-resizehandle:hover {background: #000}" + j + " img[data-mce-selected], hr[data-mce-selected] {outline: 1px solid black;resize: none}" + j + " .mce-clonedresizable {position: absolute;" + (n.gecko ? "" : "outline: 1px dashed black;") + "opacity: .5;filter: alpha(opacity=50);z-index: 10000}" + j + " .mce-resize-helper {background: #555;background: rgba(0,0,0,0.75);border-radius: 3px;border: 1px;color: white;display: none;font-family: sans-serif;font-size: 12px;white-space: nowrap;line-height: 14px;margin: 5px 10px;padding: 5px;position: absolute;z-index: 10001}"), i.on("init", function () {
                z ? (i.on("ObjectResized", function (e) {
                    ...
                    !L && /^(TABLE|IMG|HR)$/.test(t) && (i.selection.select(e.target, "TABLE" == t), i.nodeChanged())
            ...
            this.getBookmark = function (e, i) {
                ...
                if (l = n.getRng(), u = r.uniqueId(), d = n.isCollapsed(), m = "overflow:hidden;line-height:0px", l.duplicate || l.item) {
                    ...
                    c = a(l.cloneRange()), d || (c.collapse(!1), c.insertNode(r.create("span", {
                        ...
                        id: u + "_end",
                        style: m
                    }, h))), l = a(l), l.collapse(!0), l.insertNode(r.create("span", {"data-mce-type": "bookmark", id: u + "_start", style: m}, h))
                }
    ...
    }), r(M, [h, A, D, x, H, d, u], function (e, n, r, i, o, a, s) {
        function l(e, t, i, a) {
            var s = this;
        ...
        var n = e.each;
        return {getCssText: t}
    }), r(O, [h, x, H, L, u, P], function (e, t, n, r, i, o) {
        return function (a) {
            function s(e) {
            ...
            function u() {
                p({
                    ...
                    strikethrough: [{inline: "span", styles: {textDecoration: "line-through"}, exact: !0}, {inline: "strike", remove: "all"}],
            ...
            function v(t, n, r) {
                ...
                function l(e, r, o) {
                    ...
                    l = d.inline || d.block, f = U.create(l), i(f), q.walk(e, function (e) {
                        ...
                        function o(e) {
                            ...
                            }), t && !ot(t) && N(t, d) && (n = U.clone(t, Q), i(n), U.replace(n, e, Z), U.remove(t, 1)), n || e
                        }
                ...
                if (d)if (r)r.nodeType ? (h = U.createRng(), h.setStartBefore(r), h.setEndAfter(r), l(H(h, u), null, !0)) : l(r, null, !0); else if (m && d.inline && !U.select("td.mce-item-selected,th.mce-item-selected").length)z("apply", t, n); else {
                    var y = a.selection.getNode();
                    K || !u[0].defaultBlock || U.getParent(y, U.isBlock) || v(u[0].defaultBlock), a.selection.setRng(o()), p = $.getBookmark(), l(H($.getRng(Z), u), p), d.styles && (d.styles.color || d.styles.textDecoration) && (lt(y, g, "childNodes"), g(y)), $.moveToBookmark(p), W($.getRng(Z)), a.nodeChanged()
                }
            }
            ...
            function y(e, t, n, r) {
                function i(e) {
                    var n, r, o, a, s;
                    if (1 === e.nodeType && nt(e) && (a = y, y = "true" === nt(e), s = !0), n = st(e.childNodes), y && !s)for (r = 0, o = p.length; o > r && !L(p[r], t, e, e); r++);
                    if (h.deep && n.length) {
                ...
                function s(e, n, r, i) {
                    ...
                    if (e) {
                        for (u = e.parentNode, o = n.parentNode; o && o != u; o = o.parentNode) {
                            for (a = U.clone(o, Q), c = 0; c < p.length; c++)if (L(p[c], t, a, a)) {
                                a = 0;
                                break
                            }
                ...
                function d(e) {
                    ...
                    e = H(e, p, Z), h.split && (t = F(e, Z), n = F(e), t != n ? (/^(TR|TH|TD)$/.test(t.nodeName) && t.firstChild && (t = "TR" == t.nodeName ? t.firstChild.firstChild || t : t.firstChild || t), r && /^T(HEAD|BODY|FOOT|R)$/.test(r.nodeName) && /^(TH|TD)$/.test(n.nodeName) && n.firstChild && (n = n.firstChild || n), t = D(t, "span", {
                        id: "_start",
                        "data-mce-type": "bookmark"
                    }), n = D(n, "span", {
                        id: "_end",
                        "data-mce-type": "bookmark"
                    }), c(t), c(n), t = u(Z), n = u()) : t = n = c(t), e.startContainer = t.parentNode, e.startOffset = X(t), e.endContainer = n.parentNode, e.endOffset = X(n) + 1), q.walk(e, function (e) {
                        at(e, function (e) {
                            i(e), 1 === e.nodeType && "underline" === a.dom.getStyle(e, "text-decoration") && e.parentNode && "underline" === m(e.parentNode) && L({
                                deep: !1,
                                exact: !0,
                                inline: "span",
            ...
            function z(t, n, r, i) {
                ...
                function d(e, t) {
                    var n, r;
                    if (e)r = $.getRng(!0), l(e) ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), U.remove(e)) : (n = u(e), n.nodeValue.charAt(0) === G && (n.deleteData(0, 1), r.startContainer == n && r.startOffset > 0 && r.setStart(n, r.startOffset - 1), r.endContainer == n && r.endOffset > 0 && r.setEnd(n, r.endOffset - 1)), U.remove(e, 1)), $.setRng(r); else if (e = c($.getStart()), !e)for (; e = U.get(g);)d(e, !1)
                }

                function p() {
                    var e, t, i, a, s, l, d;
                    e = $.getRng(!0), a = e.startOffset, l = e.startContainer, d = l.nodeValue, t = c($.getStart()), t && (i = u(t)), d && a > 0 && a < d.length && /\w/.test(d.charAt(a)) && /\w/.test(d.charAt(a - 1)) ? (s = $.getBookmark(), e.collapse(!0), e = H(e, f(n)), e = q.split(e), v(n, r, e), $.moveToBookmark(s)) : (t && i.nodeValue === G ? v(n, r, t) : (t = o(!0), i = t.firstChild, e.insertNode(t), a = 1, v(n, r, t)), $.setCursorLocation(i, a))
                }
                ...
                function h() {
                    ...
                    if (d)if (c)l = $.getBookmark(), e.collapse(!0), e = H(e, f(n), !0), e = q.split(e), y(n, r, e), $.moveToBookmark(l); else {
                        for (m = o(), u = m, h = p.length - 1; h >= 0; h--)u.appendChild(U.clone(p[h], !1)), u = u.firstChild;
                        u.appendChild(U.doc.createTextNode(G)), u = u.firstChild;
            ...
            function W(t) {
                ...
                if (3 == n.nodeType && r >= n.nodeValue.length && (r = X(n), n = n.parentNode, i = !0), 1 == n.nodeType)for (s = n.childNodes, n = s[Math.min(r, s.length - 1)], o = new e(n, U.getParent(n, U.isBlock)), (r > s.length - 1 || i) && o.next(), a = o.current(); a; a = o.next())if (3 == a.nodeType && !B(a))return l = U.create("a", {"data-mce-bogus": "all"}, G), a.parentNode.insertBefore(l, a), t.setStart(a, 0), $.setRng(t), void U.remove(l)
            }

            var V = {}, U = a.dom, $ = a.selection, q = new t(U), j = a.schema.isValidChild, Y = U.isBlock, K = a.settings.forced_root_block, X = U.nodeIndex, G = "\ufeff", J = /^(src|href|style)$/, Q = !1, Z = !0, et, tt, nt = U.getContentEditable, rt, it, ot = n.isBookmarkNode, at = i.each, st = i.grep, lt = i.walk, ct = i.extend;
            ct(this, {
                get: f,
                register: p,
                unregister: h,
        ...
        return i = new RegExp(["<span[^>]+data-mce-bogus[^>]+>[\u200b\ufeff]+<\\/span>", '\\s?data-mce-selected="[^"]+"'].join("|"), "gi"), function (t) {
            ...
            return t.on("init", function () {
                ...
                data: c, typing: !1, beforeChange: function () {
                    f || (u = t.selection.getBookmark(2, !0))
                }, add: function (e, n) {
                    var r, i = t.settings, a;
                    if (e = e || {}, e.content = o(), f || t.removed)return null;
                    if (a = c[l], t.fire("BeforeAddUndo", {level: e, lastLevel: a, originalEvent: n}).isDefaultPrevented())return null;
        ...
        return function (i) {
            function o(o) {
                ...
                function v(e) {
                    ...
                    if (e || "TABLE" == P ? (n = a.create(e || I), g(n)) : n = A.cloneNode(!1), o = n, l.keep_styles !== !1)do if (s[t.nodeName]) {
                ...
                function b(e, t) {
                    ...
                    if (r = a.getParent(e, a.isBlock), c = i.getBody().nodeName.toLowerCase(), !r || !f(r)) {
                        if (r = r || S, !r.hasChildNodes())return n = a.create(d), g(n), r.appendChild(n), k.setStart(n, 0), k.setEnd(n, 0), n;
                ...
                function C() {
                    ...
                    function t() {
                        var e = L.parentNode;
                        return /^(LI|DT|DD)$/.test(e.nodeName) ? e : L
                    }

                    var n = L.parentNode.nodeName;
                    /^(OL|UL|LI)$/.test(n) && (I = "LI"), H = I ? v(I) : a.create("BR"), e(!0) && e() ? "LI" == n ? a.insertAfter(H, t()) : a.replace(H, L) : e(!0) ? "LI" == n ? (a.insertAfter(H, t()), H.appendChild(a.doc.createTextNode(" ")), H.appendChild(L)) : L.parentNode.insertBefore(H, L) : e() ? (a.insertAfter(H, t()), p(H)) : (L = t(), N = k.cloneRange(), N.setStartAfter(A), N.setEndAfter(L), M = N.extractContents(), "LI" == I && "LI" == M.firstChild.nodeName ? (H = M.firstChild, a.insertAfter(M, L)) : (a.insertAfter(M, L), a.insertAfter(H, L))), a.remove(A), m(H), c.add()
                }
                ...
                var k, N, S, T, R, A, B, D, H, M, L, P, O, I, F;
                if (k = s.getRng(!0), !o.isDefaultPrevented()) {
                    if (!k.collapsed)return void i.execCommand("Delete");
                    if (new t(a).normalize(k), T = k.startContainer, R = k.startOffset, I = (l.force_p_newlines ? "p" : "") || l.forced_root_block, I = I ? I.toUpperCase() : "", B = a.doc.documentMode, D = o.shiftKey, 1 == T.nodeType && T.hasChildNodes() && (F = R > T.childNodes.length - 1, T = T.childNodes[Math.min(R, T.childNodes.length - 1)] || T, R = F && 3 == T.nodeType ? T.nodeValue.length : 0), S = _(T)) {
                        if (c.beforeChange(), !a.isBlock(S) && S != a.getRoot())return void((!I || D) && x());
                        if ((I && !D || !I && D) && (T = b(T, R)), A = a.getParent(T, a.isBlock), L = A ? a.getParent(A.parentNode, a.isBlock) : null, P = A ? A.nodeName.toUpperCase() : "", O = L ? L.nodeName.toUpperCase() : "", "LI" != O || o.ctrlKey || (A = L, P = O), /^(LI|DT|DD)$/.test(P)) {
    ...
    }), r(W, [T, d, u, L, x, h], function (e, n, r, i, o, a) {
        ...
        return function (r) {
            ...
            var N = r.dom, S = r.selection, T = {state: {}, exec: {}, value: {}}, R = r.settings, A = r.formatter, B;
            l(this, {
                execCommand: v,
                queryCommandState: y,
                queryCommandValue: b,
                ...
                "mceResetDesignMode,mceBeginUndoLevel": function () {
                    ...
                    var t, n;
                    x(e), t = N.getParent(S.getNode(), "ol,ul"), t && (n = t.parentNode, /^(H[1-6]|P|ADDRESS|PRE)$/.test(n.nodeName) && (E(), N.split(n, t), k()))
                    ...
                    var i = n || S.getNode();
                    i != r.getBody() && (E(), r.dom.remove(i, m), k())
                }, mceSelectNodeDepth: function (e, t, n) {
                    var i = 0;
                    N.getParent(S.getNode(), function (e) {
                    ...
                    function c() {
                        if (w) {
                            var e = r.getBody(), t = new i(N);
                            s(N.select("*[data-mce-new]"), function (n) {
                                n.removeAttribute("data-mce-new");
                                for (var r = n.parentNode; r && r != e; r = r.parentNode)t.compare(r, n) && N.remove(n, !0)
                            })
                        }
                    }
                    ...
                    var E = y.startContainer || (y.parentElement ? y.parentElement() : null), k = r.getBody();
                    E === k && S.isCollapsed() && N.isBlock(k.firstChild) && N.isEmpty(k.firstChild) && (y = N.createRng(), y.setStart(k.firstChild, 0), y.setEnd(k.firstChild, 0), S.setRng(y)), S.isCollapsed() || r.getDoc().execCommand("Delete", !1, null), f = S.getNode();
                    var T = {context: f.nodeName.toLowerCase()};
                    if (m = u.parse(o, T), l(m), b = m.lastChild, "mce_marker" == b.attr("id"))for (v = b, b = b.prev; b; b = b.walk(!0))if (3 == b.type || !N.isBlock(b.name)) {
                    ...
                    if (T.invalid) {
                        ...
                        o = f == h ? h.innerHTML : N.getOuterHTML(f), o = d.serialize(u.parse(o.replace(/<span (id="mce_marker"|id=mce_marker).+?<\/span>/i, function () {
                            return d.serialize(m)
                        }))), f == h ? N.setHTML(h, o) : N.setOuterHTML(f, o)
                    } else o = d.serialize(m), b = f.firstChild, C = f.lastChild, !b || b === C && "BR" === b.nodeName ? N.setHTML(f, o) : S.setContent(o);
                    c(), v = N.get("mce_marker"), S.scrollIntoView(v), y = N.createRng(), b = v.previousSibling, b && 3 == b.nodeType ? (y.setStart(b, b.nodeValue.length), p || (C = v.nextSibling, C && 3 == C.nodeType && (b.appendData(C.data), C.parentNode.removeChild(C)))) : (y.setStartBefore(v), y.setEndBefore(v)), N.remove(v), S.setRng(y), r.fire("SetContent", g), r.addVisual()
                    ...
                    var t, n, i;
                    t = R.indentation, n = /[a-z%]+$/i.exec(t), t = parseInt(t, 10), y("InsertUnorderedList") || y("InsertOrderedList") ? x(e) : (R.forced_root_block || N.getParent(S.getNode(), N.isBlock) || A.apply("div"), s(S.getSelectedBlocks(), function (o) {
                        if ("LI" != o.nodeName) {
                            var a = r.getParam("indent_use_margin", !1) ? "margin" : "padding";
                            a += "rtl" == N.getStyle(o, "direction", !0) ? "Right" : "Left", "outdent" == e ? (i = Math.max(0, parseInt(o.style[a] || 0, 10) - t), N.setStyle(o, a, i ? i + n : "")) : (i = parseInt(o.style[a] || 0, 10) + t + n, N.setStyle(o, a, i))
                        }
                    }))
                }, mceRepaint: function () {
                    if (f)try {
                        E(m), S.getSel() && S.getSel().selectAllChildren(r.getBody()), S.collapse(m), k()
                    } catch (e) {
                    }
                    ...
                    var r;
                    "string" == typeof n && (n = {href: n}), r = N.getParent(S.getNode(), "a"), n.href = n.href.replace(" ", "%20"), r && n.href || A.remove("link"), n.href && A.apply("link", n, r)
                }, selectAll: function () {
                    var e = N.getRoot(), t;
                    S.getRng().setStart ? (t = N.createRng(), t.setStart(e, 0), t.setEnd(e, e.childNodes.length), S.setRng(t)) : (t = S.getRng(), t.item || (t.moveToElementText(e), t.select()))
                }, "delete": function () {
                    x("Delete");
                    var e = r.getBody();
                    N.isEmpty(e) && (r.setContent(""), e.firstChild && N.isBlock(e.firstChild) ? r.selection.setCursorLocation(e.firstChild, 0) : r.selection.setCursorLocation(e, 0))
                    ...
                    var v = N.getParent(p, N.isBlock), y = v ? v.nodeName.toUpperCase() : "", b = v ? N.getParent(v.parentNode, N.isBlock) : null, C = b ? b.nodeName.toUpperCase() : "", x = s && s.ctrlKey;
                    "LI" != C || x || (v = b, y = C), p && 3 == p.nodeType && f >= p.nodeValue.length && (h || i() || (l = N.create("br"), d.insertNode(l), d.setStartAfter(l), d.setEndAfter(l), c = !0)), l = N.create("br"), d.insertNode(l);
                    var w = N.doc.documentMode;
                    return h && "PRE" == y && (!w || 8 > w) && l.parentNode.insertBefore(N.doc.createTextNode("\r"), l), u = N.create("span", {}, "&nbsp;"), l.parentNode.insertBefore(u, l), S.scrollIntoView(u), N.remove(u), c ? (d.setStartBefore(l), d.setEndBefore(l)) : (d.setStartAfter(l), d.setEndAfter(l)), S.setRng(d), r.undoManager.add(), m
                }
            }), C({
                "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function (e) {
                    var t = "align" + e.substring(7), n = S.isCollapsed() ? [N.getParent(S.getNode(), N.isBlock)] : S.getSelectedBlocks(), r = c(n, function (e) {
                    ...
                    var e;
                    if (R.inline_styles) {
                        if ((e = N.getParent(S.getStart(), N.isBlock)) && parseInt(e.style.paddingLeft, 10) > 0)return m;
                        if ((e = N.getParent(S.getEnd(), N.isBlock)) && parseInt(e.style.paddingLeft, 10) > 0)return m
                    }
                    return y("InsertUnorderedList") || y("InsertOrderedList") || !R.inline_styles && !!N.getParent(S.getNode(), "BLOCKQUOTE")
                }, "InsertUnorderedList,InsertOrderedList": function (e) {
                    var t = N.getParent(S.getNode(), "ul,ol");
                    return t && ("insertunorderedlist" === e && "UL" === t.tagName || "insertorderedlist" === e && "OL" === t.tagName)
                }
            }, "state"), C({
                "FontSize,FontName": function (e) {
                    var t = 0, n;
                    return (n = N.getParent(S.getNode(), "span")) && (t = "fontsize" == e ? n.style.fontSize : n.style.fontFamily.replace(/, /g, ",").replace(/[\'\"]/g, "").toLowerCase()), t
                }
            }, "value"), C({
                Undo: function () {
                    r.undoManager.undo()
        ...
        function t(e) {
            ...
            function r(r, i) {
                ...
                if (r = r.toLowerCase(), i = i || {}, i.type = r, i.target || (i.target = c), i.preventDefault || (i.preventDefault = function () {
                    ...
                    }, i.isDefaultPrevented = t, i.isPropagationStopped = t, i.isImmediatePropagationStopped = t), e.beforeFire && e.beforeFire(i), a = u[r])for (s = 0, l = a.length; l > s; s++) {
            ...
            function i(e, n, r) {
                var i, o, a;
                if (n === !1 && (n = t), n)for (o = e.toLowerCase().split(" "), a = o.length; a--;)e = o[a], i = u[e], i || (i = u[e] = [], d(e, !0)), r ? i.unshift(n) : i.push(n);
                return l
            }
            ...
            function o(e, t) {
                ...
                if (e)for (o = e.toLowerCase().split(" "), n = o.length; n--;) {
                    ...
                    if (r) {
                        if (t)for (a = r.length; a--;)r[a] === t && (r = r.slice(0, a).concat(r.slice(a + 1)), u[e] = r); else r.length = 0;
        ...
        var a = "onmousewheel"in document, s = !1, l = "mce-", c = e.extend({
            Statics: {classPrefix: l}, isRtl: function () {
                return c.rtl
    ...
    }), r(J, [K, j, q, X, G, u, Y], function (e, t, n, r, i, o, a) {
        var s = {};
        return e.extend({
        ...
        return function (a) {
            ...
            function C() {
                ...
                }), X.addNodeFilter("pre", function (e) {
            ...
            function R() {
                ...
                }), X.addNodeFilter("noscript", function (e) {
            ...
            var V = o.each, U = e.BACKSPACE, $ = e.DELETE, q = a.dom, j = a.selection, Y = a.settings, K = a.parser, X = a.serializer, G = i.gecko, J = i.ie, Q = i.webkit;
            w(), d(), B(), Q && (u(), p(), g(), k(), z(), b(), W(), F(), i.iOS ? (H(), M(), I()) : f()), J && i.ie < 11 && (h(), y(), C(), x(), S(), T(), R(), A()), i.ie >= 11 && (M(), O(), b()), i.ie && (f(), P()), G && (h(), m(), v(), _(), E(), N(), D(), L(), b())
        }
    }), r(lt, [$], function (e) {
        function t(t) {
    ...
    }), r(dt, [y, f, C, w, _, R, T, M, O, I, F, z, W, V, b, c, at, E, N, st, d, u, ct, ut], function (e, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v, y, b, C, x, w, _, E) {
        function k(e, t, i) {
            var o = this, a, s;
        ...
        var N = e.DOM, S = r.ThemeManager, T = r.PluginManager, R = w.extend, A = w.each, B = w.explode, D = w.inArray, H = w.trim, M = w.resolve, L = g.Event, P = x.gecko, O = x.ie;
        return k.prototype = {
            render: function () {
                function e() {
                ...
                function t() {
                    ...
                    w.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")), A(r.external_plugins, function (e, t) {
                        ...
                        if (e = H(e), e && !T.urls[e])if ("-" == e.charAt(0)) {
                ...
                function e(n) {
                    var r = T.get(n), i, o;
                    i = T.urls[n] || t.documentBaseUrl.replace(/\/$/, ""), n = H(n), r && -1 === D(m, n) && (A(T.dependencies(n), function (t) {
                        e(t)
                ...
                if (y.onload = function () {
                    ...
                    }, N.setAttrib(y, "src", u || 'javascript:""'), t.contentAreaContainer = l.iframeContainer, t.iframeElement = y, s = N.add(l.iframeContainer, y), O)try {
                    t.getDoc()
                } catch (b) {
                    s.src = u = v
                }
                l.editorContainer && (N.get(l.editorContainer).style.display = t.orgDisplay, t.hidden = N.isHidden(l.editorContainer)), t.getElement().style.display = "none", N.setAttrib(t.id, "aria-hidden", !0), u || t.initContentBody(), r = s = l = null
                ...
                r.inline || (n.getElement().style.visibility = n.orgVisibility), t || r.content_editable || (h.open(), h.write(n.iframeHTML), h.close()), r.content_editable && (n.on("remove", function () {
                    ...
                    initial: !0,
                    format: "html"
                }), n.startContent = n.getContent({format: "raw"}), n.initialized = !0, n.bindPendingEventDelegates(), n.fire("init"), n.focus(!0), n.nodeChanged({initial: !0}), n.execCallback("init_instance_callback", n), n.contentStyles.length > 0 && (g = "", A(n.contentStyles, function (e) {
                    g += e + "\r\n"
                ...
                return "hash" === n ? (i = {}, "string" == typeof r ? A(r.split(r.indexOf("=") > 0 ? /[;,](?![^=;,]*(?:[;,]|$))/ : ","), function (e) {
                    e = e.split("="), i[H(e[0])] = H(e.length > 1 ? e[1] : e)
                }) : i = r, i) : r
                ...
                e.hidden || (O && t && !e.inline && t.execCommand("SelectAll"), e.save(), e.inline ? (e.getBody().contentEditable = !1, e == e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (N.hide(e.getContainer()), N.setStyle(e.id, "display", e.orgDisplay)), e.hidden = !0, e.fire("hide"))
            }, isHidden: function () {
                return !!this.hidden
                ...
                if (n && t.initialized)return e = e || {}, e.save = !0, e.element = n, r = e.content = t.getContent(e), e.no_events || t.fire("SaveContent", e), r = e.content, /TEXTAREA|INPUT/i.test(n.nodeName) ? n.value = r : (t.inline || (n.innerHTML = r), (i = N.getParent(t.id, "form")) && A(i.elements, function (e) {
                ...
                return this.targetElm || (this.targetElm = N.get(this.id)), this.targetElm
            }, getWin: function () {
                var e = this, t;
                ...
                var e = this;
                e.removed || (e.save(), e.removed = 1, e.unbindAllNativeEvents(), e.hasHiddenInput && N.remove(e.getElement().nextSibling), e.inline || (O && 10 > O && e.getDoc().execCommand("SelectAll", !1, null), N.setStyle(e.id, "display", e.orgDisplay), e.getBody().onload = null), e.fire("remove"), e.editorManager.remove(e), N.remove(e.getContainer()), e.destroy())
            }, destroy: function (e) {
                var t = this, n;
                if (!t.destroyed) {
        ...
        return e
    }), r(Mt, [kt, Q, Y, Ht], function (e, t, n, r) {
        return e.extend({
            Defaults: {classes: "widget colorpicker"}, init: function (e) {
                ...
                function i(e, t) {
                    var i = (360 - e.h) / 360;
                    n.css(d, {top: 100 * i + "%"}), t || n.css(p, {left: e.s + "%", top: 100 - e.v + "%"}), f.style.background = new r({
                        s: 100,
                        v: 100,
                        h: e.h
                    }).toHex(), s.color().parse({s: e.s, v: e.v, h: e.h})
                }
                ...
                u = s.getEl("h"), d = s.getEl("hp"), f = s.getEl("sv"), p = s.getEl("svp"), s._repaint = function () {
                    c = l.toHsv(), i(c)
                }, s._super(), s._svdraghelper = new t(s._id + "-sv", {start: o, drag: o}), s._hdraghelper = new t(s._id + "-h", {
                    start: a,
                    drag: a
                }), s._repaint()
            }, rgb: function () {
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v = [], y, b, C, x, w, _, E, k, N, S, T, R, A, B, D, H, M, L, P, O, I, F, z = Math.max, W = Math.min;
                ...
                if (x = {}, x[k] = 0 > d ? i[k] - d + i[A] : i[R] - d + i[A], x[L] = _ + i[I], x[B] = i[R] - d, x[F] = _, x.minW = W(x.minW, i.maxW), x.minH = W(x.minH, i.maxH), x.minW = z(x.minW, i.startMinWidth), x.minH = z(x.minH, i.startMinHeight), !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
                    for (C = d / u, t = 0, n = v.length; n > t; t++)p = v[t], h = p.layoutRect(), b = h[S], y = h[k] + h.flex * C, y > b ? (d -= h[S] - h[k], u -= h.flex, h.flex = 0, h.maxFlexSize = b) : h.maxFlexSize = 0;
        ...
        return e.extend({
            Defaults: {containerClass: "flow-layout", controlClass: "flow-layout-item", endClass: "break"}, recalc: function (e) {
                e.items().filter(":visible").each(function (e) {
                    e.recalc && e.recalc()
                })
            }
        })
    }), r($t, [K, kt, rt, u, ht, d], function (e, t, n, r, i, o) {
        function a(e) {
            function t(t, n) {
                return function () {
                    var r = this;
            ...
            function i() {
                ...
                var r = 0, i = [], o = [{
                    ...
                    items: [{title: "Left", icon: "alignleft", format: "alignleft"}, {
                        ...
                        icon: "aligncenter",
                        format: "aligncenter"
                    }, {title: "Right", icon: "alignright", format: "alignright"}, {title: "Justify", icon: "alignjustify", format: "alignjustify"}]
                }];
        ...
        return e.extend({
            recalc: function (e) {
                var t = e.settings, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v, y, b, C, x, w, _, E = [], k = [], N, S, T, R, A, B;
                ...
                for (f = 0; n > f; f++)k.push(0);
                for (f = 0; n > f; f++)for (d = 0; r > d && (u = i[f * r + d], u); d++)c = u.layoutRect(), N = c.minW, S = c.minH, E[d] = N > E[d] ? N : E[d], k[f] = S > k[f] ? S : k[f];
                for (T = o.innerW - g.left - g.right, w = 0, d = 0; r > d; d++)w += E[d] + (d > 0 ? y : 0), T -= (d > 0 ? y : 0) + E[d];
                for (R = o.innerH - g.top - g.bottom, _ = 0, f = 0; n > f; f++)_ += k[f] + (f > 0 ? b : 0), R -= (f > 0 ? b : 0) + k[f];
                if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                    ...
                    if (M)for (d = 0; d < M.length; d++)H += M[d]; else H = r;
                    var L = T / H;
                    for (d = 0; r > d; d++)E[d] += M ? M[d] * L : L;
                    for (h = g.top, f = 0; n > f; f++) {
                        for (p = g.left, s = k[f] + D, d = 0; r > d && (B = A ? f * r + r - 1 - d : f * r + d, u = i[B], u); d++)m = u.settings, c = u.layoutRect(), a = Math.max(E[d], c.startMinWidth), c.x = p, c.y = h, v = m.alignH || (C ? C[d] || C[0] : null), "center" == v ? c.x = p + a / 2 - c.w / 2 : "right" == v ? c.x = p + a - c.w : "stretch" == v && (c.w = a), v = m.alignV || (x ? x[d] || x[0] : null), "center" == v ? c.y = h + s / 2 - c.h / 2 : "bottom" == v ? c.y = h + s - c.h : "stretch" == v && (c.h = s), u.layoutRect(c), p += a + y, u.recalc && u.recalc();
                        h += s + b
                    }
    ...
    }),a([l, c, u, d, f, p, h, m, g, y, b, C, _, E, k, N, S, T, R, A, B, D, H, M, L, O, I, F, z, W, V, U, $, q, j, Y, K, X, G, J, Q, Z, et, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, pt, ht, mt, gt, vt, yt, bt, Ct, xt, wt, _t, Et, kt, Nt, St, Tt, Rt, At, Bt, Dt, Ht, Mt, Lt, Pt, Ot, It, Ft, zt, Wt, Vt, Ut, $t, qt, jt, Yt, Kt, Xt, Gt, Jt, Qt, Zt, en, tn, nn, rn, on, an, sn, ln])
}(this);
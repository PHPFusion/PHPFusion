 ...
 * @param string|null $filter        Conditions
 * @param string      $query_replace Replace the entire query
 *
 * @return array Returns cat-id relationships
 */
function dbquery_tree($db, $id_col, $cat_col, $filter = NULL, $query_replace = "") {
    $index = [];
 ...
 * @param string|null $filter        replace conditional structure
 * @param string      $query_replace replace the entire query structure
 *
 * @return array Returns cat-id relationships with full data
 */
function dbquery_tree_full($db, $id_col, $cat_col, $filter = NULL, $query_replace = "") {
    //$data = [];
    $index = [];
 ...
 * @param string|null $value_to_match
 *
 * @return int
...
function dbquery_insert($table, $inputdata, $mode, array $options = []) {
    ...
    $sqlPatterns = [
        ...
        'multi_update' => 'INSERT INTO `{table}` {values} VALUES {multi_values} ON DUPLICATE KEY UPDATE {key_values}',
    ];
 ...
 * @param string|null $id_col
 * @param int         $current_category
 * @param string|null $cat_col

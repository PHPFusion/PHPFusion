...
class Errors {
        ...
        if ($this->error_id) {
            ...
            <div class='m-t-20'>
                ...
                <div class='m-t-10'>
                    ...
                    <span class='text-lighter'><?php echo $locale['423'] ?></span>
    ...
    public function showFooterErrors() {
        ...
        if (iADMIN && checkrights("ERRO") && (count($this->errors) || count($this->new_errors)) && !defined("NO_DEBUGGER")) {
            ...
            $cHtml = openmodal('tbody', $locale['425'],

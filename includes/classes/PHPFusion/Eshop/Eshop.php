...
class Eshop {
	...
	static function get_iColor($key= 0) {
		global $colornames;
		$ESHOPCOLOURS[1] = array('hex'=>'#F0F8FF', 'title'=>$colornames['1']);
		$ESHOPCOLOURS[2] = array('hex'=>'#FAEBD7', 'title'=>$colornames['2']);
		$ESHOPCOLOURS[3] = array('hex'=>'#00FFFF', 'title'=>$colornames['3']);
		$ESHOPCOLOURS[4] = array('hex'=>'#7FFFD4', 'title'=>$colornames['4']);
		$ESHOPCOLOURS[5] = array('hex'=>'#F0FFFF', 'title'=>$colornames['5']);
		$ESHOPCOLOURS[6] = array('hex'=>'#F5F5DC', 'title'=>$colornames['6']);
		$ESHOPCOLOURS[7] = array('hex'=>'#FFE4C4', 'title'=>$colornames['7']);
		$ESHOPCOLOURS[8] = array('hex'=>'#000000', 'title'=>$colornames['8']);
		$ESHOPCOLOURS[9] = array('hex'=>'#FFEBCD', 'title'=>$colornames['9']);
		$ESHOPCOLOURS[10] = array('hex'=>'#0000FF', 'title'=>$colornames['10']);
		$ESHOPCOLOURS[11] = array('hex'=>'#8A2BE2', 'title'=>$colornames['11']);
		$ESHOPCOLOURS[12] = array('hex'=>'#A52A2A', 'title'=>$colornames['12']);
		$ESHOPCOLOURS[13] = array('hex'=>'#DEB887', 'title'=>$colornames['13']);
		$ESHOPCOLOURS[14] = array('hex'=>'#5F9EA0', 'title'=>$colornames['14']);
		$ESHOPCOLOURS[15] = array('hex'=>'#7FFF00', 'title'=>$colornames['15']);
		$ESHOPCOLOURS[16] = array('hex'=>'#D2691E', 'title'=>$colornames['16']);
		$ESHOPCOLOURS[17] = array('hex'=>'#FF7F50', 'title'=>$colornames['17']);
		$ESHOPCOLOURS[18] = array('hex'=>'#6495ED', 'title'=>$colornames['18']);
		$ESHOPCOLOURS[19] = array('hex'=>'#FFF8DC', 'title'=>$colornames['19']);
		$ESHOPCOLOURS[20] = array('hex'=>'#DC143C', 'title'=>$colornames['20']);
		$ESHOPCOLOURS[21] = array('hex'=>'#00FFFF', 'title'=>$colornames['21']);
		$ESHOPCOLOURS[22] = array('hex'=>'#00008B', 'title'=>$colornames['22']);
		$ESHOPCOLOURS[23] = array('hex'=>'#008B8B', 'title'=>$colornames['23']);
		$ESHOPCOLOURS[24] = array('hex'=>'#B8860B', 'title'=>$colornames['24']);
		$ESHOPCOLOURS[25] = array('hex'=>'#A9A9A9', 'title'=>$colornames['25']);
		$ESHOPCOLOURS[26] = array('hex'=>'#BDB76B', 'title'=>$colornames['26']);
		$ESHOPCOLOURS[27] = array('hex'=>'#8B008B', 'title'=>$colornames['27']);
		$ESHOPCOLOURS[28] = array('hex'=>'#556B2F', 'title'=>$colornames['28']);
		$ESHOPCOLOURS[29] = array('hex'=>'#FF8C00', 'title'=>$colornames['29']);
		$ESHOPCOLOURS[30] = array('hex'=>'#9932CC', 'title'=>$colornames['30']);
		$ESHOPCOLOURS[31] = array('hex'=>'#8B0000', 'title'=>$colornames['31']);
		$ESHOPCOLOURS[32] = array('hex'=>'#E9967A', 'title'=>$colornames['32']);
		$ESHOPCOLOURS[33] = array('hex'=>'#8FBC8F', 'title'=>$colornames['33']);
		$ESHOPCOLOURS[34] = array('hex'=>'#483D8B', 'title'=>$colornames['34']);
		$ESHOPCOLOURS[35] = array('hex'=>'#2F4F4F', 'title'=>$colornames['35']);
		$ESHOPCOLOURS[36] = array('hex'=>'#00CED1', 'title'=>$colornames['36']);
		$ESHOPCOLOURS[37] = array('hex'=>'#9400D3', 'title'=>$colornames['37']);
		$ESHOPCOLOURS[38] = array('hex'=>'#FF1493', 'title'=>$colornames['38']);
		$ESHOPCOLOURS[39] = array('hex'=>'#00BFFF', 'title'=>$colornames['39']);
		$ESHOPCOLOURS[40] = array('hex'=>'#696969', 'title'=>$colornames['40']);
		$ESHOPCOLOURS[41] = array('hex'=>'#1E90FF', 'title'=>$colornames['41']);
		$ESHOPCOLOURS[42] = array('hex'=>'#B22222', 'title'=>$colornames['42']);
		$ESHOPCOLOURS[43] = array('hex'=>'#FFFAF0', 'title'=>$colornames['43']);
		$ESHOPCOLOURS[44] = array('hex'=>'#228B22', 'title'=>$colornames['44']);
		$ESHOPCOLOURS[45] = array('hex'=>'#FF00FF', 'title'=>$colornames['45']);
		$ESHOPCOLOURS[46] = array('hex'=>'#DCDCDC', 'title'=>$colornames['46']);
		$ESHOPCOLOURS[47] = array('hex'=>'#F8F8FF', 'title'=>$colornames['47']);
		$ESHOPCOLOURS[48] = array('hex'=>'#FFD700', 'title'=>$colornames['48']);
		$ESHOPCOLOURS[49] = array('hex'=>'#DAA520', 'title'=>$colornames['49']);
		$ESHOPCOLOURS[50] = array('hex'=>'#808080', 'title'=>$colornames['50']);
		$ESHOPCOLOURS[51] = array('hex'=>'#008000', 'title'=>$colornames['51']);
		$ESHOPCOLOURS[52] = array('hex'=>'#ADFF2F', 'title'=>$colornames['52']);
		$ESHOPCOLOURS[53] = array('hex'=>'#F0FFF0', 'title'=>$colornames['53']);
		$ESHOPCOLOURS[54] = array('hex'=>'#FF69B4', 'title'=>$colornames['54']);
		$ESHOPCOLOURS[55] = array('hex'=>'#CD5C5C', 'title'=>$colornames['55']);
		$ESHOPCOLOURS[56] = array('hex'=>'#4B0082', 'title'=>$colornames['56']);
		$ESHOPCOLOURS[57] = array('hex'=>'#F0E68C', 'title'=>$colornames['57']);
		$ESHOPCOLOURS[58] = array('hex'=>'#E6E6FA', 'title'=>$colornames['58']);
		$ESHOPCOLOURS[59] = array('hex'=>'#FFF0F5', 'title'=>$colornames['59']);
		$ESHOPCOLOURS[60] = array('hex'=>'#7CFC00', 'title'=>$colornames['60']);
		$ESHOPCOLOURS[61] = array('hex'=>'#FFFACD', 'title'=>$colornames['61']);
		$ESHOPCOLOURS[62] = array('hex'=>'#ADD8E6', 'title'=>$colornames['62']);
		$ESHOPCOLOURS[63] = array('hex'=>'#F08080', 'title'=>$colornames['63']);
		$ESHOPCOLOURS[64] = array('hex'=>'#E0FFFF', 'title'=>$colornames['64']);
		$ESHOPCOLOURS[65] = array('hex'=>'#FAFAD2', 'title'=>$colornames['65']);
		$ESHOPCOLOURS[66] = array('hex'=>'#D3D3D3', 'title'=>$colornames['66']);
		$ESHOPCOLOURS[67] = array('hex'=>'#90EE90', 'title'=>$colornames['67']);
		$ESHOPCOLOURS[68] = array('hex'=>'#FFB6C1', 'title'=>$colornames['68']);
		$ESHOPCOLOURS[69] = array('hex'=>'#FFA07A', 'title'=>$colornames['69']);
		$ESHOPCOLOURS[70] = array('hex'=>'#20B2AA', 'title'=>$colornames['70']);
		$ESHOPCOLOURS[71] = array('hex'=>'#87CEFA', 'title'=>$colornames['71']);
		$ESHOPCOLOURS[72] = array('hex'=>'#778899', 'title'=>$colornames['72']);
		$ESHOPCOLOURS[73] = array('hex'=>'#B0C4DE', 'title'=>$colornames['73']);
		$ESHOPCOLOURS[74] = array('hex'=>'#FFFFE0', 'title'=>$colornames['74']);
		$ESHOPCOLOURS[75] = array('hex'=>'#00FF00', 'title'=>$colornames['75']);
		$ESHOPCOLOURS[76] = array('hex'=>'#FF00FF', 'title'=>$colornames['76']);
		$ESHOPCOLOURS[77] = array('hex'=>'#800000', 'title'=>$colornames['77']);
		$ESHOPCOLOURS[78] = array('hex'=>'#66CDAA', 'title'=>$colornames['78']);
		$ESHOPCOLOURS[79] = array('hex'=>'#0000CD', 'title'=>$colornames['79']);
		$ESHOPCOLOURS[80] = array('hex'=>'#BA55D3', 'title'=>$colornames['80']);
		$ESHOPCOLOURS[81] = array('hex'=>'#9370DB', 'title'=>$colornames['81']);
		$ESHOPCOLOURS[82] = array('hex'=>'#3CB371', 'title'=>$colornames['82']);
		$ESHOPCOLOURS[83] = array('hex'=>'#7B68EE', 'title'=>$colornames['83']);
		$ESHOPCOLOURS[84] = array('hex'=>'#00FA9A', 'title'=>$colornames['84']);
		$ESHOPCOLOURS[85] = array('hex'=>'#48D1CC', 'title'=>$colornames['85']);
		$ESHOPCOLOURS[86] = array('hex'=>'#C71585', 'title'=>$colornames['86']);
		$ESHOPCOLOURS[87] = array('hex'=>'#191970', 'title'=>$colornames['87']);
		$ESHOPCOLOURS[88] = array('hex'=>'#F5FFFA', 'title'=>$colornames['88']);
		$ESHOPCOLOURS[89] = array('hex'=>'#FFE4E1', 'title'=>$colornames['89']);
		$ESHOPCOLOURS[90] = array('hex'=>'#FFE4B5', 'title'=>$colornames['90']);
		$ESHOPCOLOURS[91] = array('hex'=>'#FFDEAD', 'title'=>$colornames['91']);
		$ESHOPCOLOURS[92] = array('hex'=>'#000080', 'title'=>$colornames['92']);
		$ESHOPCOLOURS[93] = array('hex'=>'#FDF5E6', 'title'=>$colornames['93']);
		$ESHOPCOLOURS[94] = array('hex'=>'#808000', 'title'=>$colornames['94']);
		$ESHOPCOLOURS[95] = array('hex'=>'#6B8E23', 'title'=>$colornames['95']);
		$ESHOPCOLOURS[96] = array('hex'=>'#FFA500', 'title'=>$colornames['96']);
		$ESHOPCOLOURS[97] = array('hex'=>'#FF4500', 'title'=>$colornames['97']);
		$ESHOPCOLOURS[98] = array('hex'=>'#DA70D6', 'title'=>$colornames['98']);
		$ESHOPCOLOURS[99] = array('hex'=>'#EEE8AA', 'title'=>$colornames['99']);
		$ESHOPCOLOURS[100] = array('hex'=>'#98FB98', 'title'=>$colornames['100']);
		$ESHOPCOLOURS[101] = array('hex'=>'#AFEEEE', 'title'=>$colornames['101']);
		$ESHOPCOLOURS[102] = array('hex'=>'#DB7093', 'title'=>$colornames['102']);
		$ESHOPCOLOURS[103] = array('hex'=>'#FFEFD5', 'title'=>$colornames['103']);
		$ESHOPCOLOURS[104] = array('hex'=>'#FFDAB9', 'title'=>$colornames['104']);
		$ESHOPCOLOURS[105] = array('hex'=>'#CD853F', 'title'=>$colornames['105']);
		$ESHOPCOLOURS[106] = array('hex'=>'#FFC0CB', 'title'=>$colornames['106']);
		$ESHOPCOLOURS[107] = array('hex'=>'#DDA0DD', 'title'=>$colornames['107']);
		$ESHOPCOLOURS[108] = array('hex'=>'#B0E0E6', 'title'=>$colornames['108']);
		$ESHOPCOLOURS[109] = array('hex'=>'#800080', 'title'=>$colornames['109']);
		$ESHOPCOLOURS[110] = array('hex'=>'#FF0000', 'title'=>$colornames['110']);
		$ESHOPCOLOURS[111] = array('hex'=>'#BC8F8F', 'title'=>$colornames['111']);
		$ESHOPCOLOURS[112] = array('hex'=>'#8B4513', 'title'=>$colornames['112']);
		$ESHOPCOLOURS[113] = array('hex'=>'#FA8072', 'title'=>$colornames['113']);
		$ESHOPCOLOURS[114] = array('hex'=>'#F4A460', 'title'=>$colornames['114']);
		$ESHOPCOLOURS[115] = array('hex'=>'#2E8B57', 'title'=>$colornames['115']);
		$ESHOPCOLOURS[116] = array('hex'=>'#FFF5EE', 'title'=>$colornames['116']);
		$ESHOPCOLOURS[117] = array('hex'=>'#A0522D', 'title'=>$colornames['117']);
		$ESHOPCOLOURS[118] = array('hex'=>'#C0C0C0', 'title'=>$colornames['118']);
		$ESHOPCOLOURS[119] = array('hex'=>'#87CEEB', 'title'=>$colornames['119']);
		$ESHOPCOLOURS[120] = array('hex'=>'#6A5ACD', 'title'=>$colornames['120']);
		$ESHOPCOLOURS[121] = array('hex'=>'#708090', 'title'=>$colornames['121']);
		$ESHOPCOLOURS[122] = array('hex'=>'#FFFAFA', 'title'=>$colornames['122']);
		$ESHOPCOLOURS[123] = array('hex'=>'#00FF7F', 'title'=>$colornames['123']);
		$ESHOPCOLOURS[124] = array('hex'=>'#4682B4', 'title'=>$colornames['124']);
		$ESHOPCOLOURS[125] = array('hex'=>'#D2B48C', 'title'=>$colornames['125']);
		$ESHOPCOLOURS[126] = array('hex'=>'#008080', 'title'=>$colornames['126']);
		$ESHOPCOLOURS[127] = array('hex'=>'#D8BFD8', 'title'=>$colornames['127']);
		$ESHOPCOLOURS[128] = array('hex'=>'#FF6347', 'title'=>$colornames['128']);
		$ESHOPCOLOURS[129] = array('hex'=>'#40E0D0', 'title'=>$colornames['129']);
		$ESHOPCOLOURS[130] = array('hex'=>'#EE82EE', 'title'=>$colornames['130']);
		$ESHOPCOLOURS[131] = array('hex'=>'#F5DEB3', 'title'=>$colornames['131']);
		$ESHOPCOLOURS[132] = array('hex'=>'#FFFFFF', 'title'=>$colornames['132']);
		$ESHOPCOLOURS[133] = array('hex'=>'#F5F5F5', 'title'=>$colornames['133']);
		$ESHOPCOLOURS[134] = array('hex'=>'#FFFF00', 'title'=>$colornames['134']);
		$ESHOPCOLOURS[135] = array('hex'=>'#9ACD32', 'title'=>$colornames['135']);

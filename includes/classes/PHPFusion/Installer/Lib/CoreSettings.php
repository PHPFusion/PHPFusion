...
class CoreSettings {
    ...
    public static function get_table_rows($table_name, $localeset = 'English') {
        ...
        include is_file($social_locale_file)
            ? $social_locale_file
            : BASEDIR."locale/English/social.php";

        // Load supplied core user_fields locale
        foreach (['user_web', 'user_realname', 'user_twitter', 'user_linkedin', 'user_discord'] as $userFieldLocale) {
            $userFieldLocaleFile = BASEDIR."locale/{$localeset}/user_fields/{$userFieldLocale}.php";
            include is_file($userFieldLocaleFile)
                ? $userFieldLocaleFile
                : BASEDIR."locale/English/user_fields/{$userFieldLocale}.php";
        }
        ...
        $table_settings['admin'] = [
            'insert' => [
                ...
                [
                    'admin_rights'   => 'SOC',
                    'admin_image'    => 'members.png',
                    'admin_title'    => $locale['SOCIAL_000'],
                    'admin_link'     => 'social.php',
                    'admin_page'     => 2,
                    'admin_language' => $localeset
                ],
                [
        ...
        $table_settings['user_fields'] = [
            'insert' => [
                [
                    'field_name'     => 'user_realname',
                    'field_title'    => $locale['urn_100'],
                    'field_cat'      => 3,
                    'field_type'     => 'file',
                    'field_required' => 1,
                    'field_order'    => 3,
                ...
                [
                    ...
                    'field_title'    => $locale['uf_linkedin'],
                    'field_cat'      => 3,
                    'field_type'     => 'file',
                    'field_required' => 0,
                    'field_order'    => 5,
                ...
                [
                    'field_name'     => 'user_discord',
                    'field_title'    => $locale['uf_discord'],
                    'field_cat'      => 3,
                    'field_type'     => 'file',
                    'field_required' => 0,
                    'field_order'    => 6,

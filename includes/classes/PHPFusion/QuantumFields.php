...
class QuantumFields extends QuantumFactory {
    ...
    private function quantumDynamicsForm() {
        ...
        echo form_select( 'field_cat', $this->locale['fields_0450'], $this->field_data['field_cat'], [
            'db'           => DB_USER_FIELD_CATS,
            'title_col'    => 'field_cat_name',
            'id_col'       => 'field_cat_id',
            'cat_col'      => 'field_parent',
    ...
    private function displayModuleForm() {
        ...
        echo form_select( 'field_cat', $this->locale['fields_0410'], $this->field_data['field_cat'], [
                'db'           => DB_USER_FIELD_CATS,
                'title_col'    => 'field_cat_name',
                'id_col'       => 'field_cat_id',
                'cat_col'      => 'field_parent',

...
class UserFields {
	...
	public function displayInput() {
		...
		} elseif (preg_match('/edit_profile.php/i', $_SERVER['PHP_SELF']) || preg_match('/edit-profile/i', $_SERVER['REQUEST_URI'])) {
	...
	private function renderAdminOptions() {
		...
		$this->html .= "<div style='margin:5px'></div>\n";
		$this->html .= "<form name='admin_form' method='post' action='".BASEDIR."profile.php?lookup=".$this->userData['user_id']."'>\n";
	...
	private function renderAvatarInput() {
		...
		$this->html .= "<tr>\n<td colspan='2' class='profile_category_name tbl2'><strong>".$locale['u185']."</strong></td></tr>\n";
		$this->html .= "<tr>\n";

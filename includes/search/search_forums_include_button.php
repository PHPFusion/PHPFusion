...
$form_elements['forums']['enabled'] = ["datelimit", "fields1", "fields2", "fields3", "sort", "order1", "order2", "chars"];
$form_elements['forums']['disabled'] = [];
$form_elements['forums']['display'] = [];
$form_elements['forums']['nodisplay'] = [];

    ...
    if (Search_Engine::get_param('stype') == 'news' || Search_Engine::get_param('stype') == 'all') {
        ...
        if ($rows != 0) {
            ...
            while ($data = dbarray($result)) {
                ...
                $search_result .= "<li>\n<a href='".INFUSIONS."news/news.php?readmore=".$data['news_id']."'>".$data['news_subject']."</a>"."<br /><br />\n";
                ...
                $search_result .= $text_c2." ".($text_c2 == 1 ? $locale['520'] : $locale['521'])." ".$locale['n403']." ".$locale['n406']."</span></li>\n";
            }
